...
import { ObjectResultProps } from '@atlaskit/quick-search';
import { ContainerResultProps } from '@atlaskit/quick-search';
import { PersonResultProps } from '@atlaskit/quick-search';
