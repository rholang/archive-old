...
import { ActionProps } from '@atlaskit/modal-dialog/types';

const defaults = ['header', 'footer', 'both', 'neither'];
const custom = ['custom header', 'custom body'];
...
export default class ModalDialogVideo extends React.Component<{}, State> {
  state = { isOpen: null };
