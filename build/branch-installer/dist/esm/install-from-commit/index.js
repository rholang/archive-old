...
function _getInstalledAtlaskitDependencies() {
  _getInstalledAtlaskitDependencies = _asyncToGenerator(
  /*#__PURE__*/
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 12:
            atlaskitDependencies = flattenDeep(['dependencies', 'devDependencies', 'bundledDependencies', 'optionalDependencies', 'peerDependencies'].filter(function (depType) {
              return _typeof(packageJSON[depType]) === 'object';
...
function _getManifestForCommit() {
  _getManifestForCommit = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime.mark(function _callee4(commitHash) {
    var options,
        manifestUrl,
        log,
        interval,
...
function _installFromCommit2() {
  _installFromCommit2 = _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            options = _objectSpread({}, defaultOptions, userOptions);
...
function _installFromCommit3() {
  _installFromCommit3 = _asyncToGenerator(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            verboseLog(_objectSpread({}, options, {
              commitHash: commitHash
            }));
            _context7.next = 8;
            return getManifestForCommit(commitHash, _objectSpread({}, options, {
              log: log,
          ...
          case 16:
            ...
            cmdArgs = [cmd].concat(_toConsumableArray(options.extraArgs)); // args that we'll pass to the engine ('add'/'upgrade' pkgName@url pkgName@url)
          ...
          case 25:
            ...
            function () {
              ...
              /*#__PURE__*/
              _regeneratorRuntime.mark(function _callee6(bail) {
