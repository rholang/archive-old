...
exports.default = getChangesetInfo;
...
function getFullDiffStat(url) {
  ...
  return promisifyAPRequest(url).then(function (res) {
    var values = [].concat((0, _toConsumableArray2.default)(allValues), (0, _toConsumableArray2.default)(res.values));
...
function getChangesetInfo(user, repo, sourcehash, destinationhash, v2) {
