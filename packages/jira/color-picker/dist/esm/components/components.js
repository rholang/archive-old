...
export var MenuList = function (props) {
    var cx = props.cx, cols = props.selectProps.cols, rest = __rest(props, ["cx", "selectProps"]);
    return (React.createElement(ColorPaletteContainer, __assign({ style: {
...
export var Option = function (props) {
    ...
    return (React.createElement(ColorCardWrapper, __assign({}, props.innerProps),
