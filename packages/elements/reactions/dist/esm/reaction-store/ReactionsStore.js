...
var MemoryReactionsStore = /** @class */ (function () {
    function MemoryReactionsStore(client, state) {
        ...
        this.setReactions = function (containerAri, ari, reactions) {
            var _a;
            _this.setState({
                reactions: __assign(__assign({}, _this.state.reactions), (_a = {}, _a[containerAri + "|" + ari] = reactions, _a)),
            });
        };
        this.handleDetailedReactionResponse = function (detailedReaction) {
            ...
            _this.withReaction(function (reaction) { return (__assign(__assign({}, reaction), { users: detailedReaction.users })); })(containerAri, ari, emojiId);
        };
            ...
            _this.withReadyReaction(containerAri, ari)(function (reactionState) {
                ...
                var reactions = reactionState.reactions.map(function (reaction) {
                    if (reaction.emojiId === emojiId) {
                        ...
                        if (updated) {
                            return __assign(__assign({}, updated), { optimisticallyUpdated: true });
                        }
                    }
                    return reaction;
                });
                if (!found) {
                    ...
                    if (updated) {
                        reactions.push(__assign(__assign({}, updated), { optimisticallyUpdated: true }));
                    }
                }
    ...
    MemoryReactionsStore.prototype.setFlash = function (containerAri, ari, emojiId, flash) {
        var _a, _b;
        this.setState({
            flash: __assign(__assign({}, this.state.flash), (_a = {}, _a[containerAri + "|" + ari] = __assign(__assign({}, this.state.flash[containerAri + "|" + ari]), (_b = {}, _b[emojiId] = flash, _b)), _a)),
        });
    };
    /**
