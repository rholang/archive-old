...
var MemoryReactionsStore = /** @class */ (function () {
    function MemoryReactionsStore(client, state) {
        ...
        this.setState = function (newState) {
            _this.state = tslib_1.__assign(tslib_1.__assign({}, _this.state), newState);
            _this.triggerOnChange();
        };
        // batch calls to onChange using the latest state in it.
        this.triggerOnChange = batched_1.batch(function () {
        ...
        this.setReactions = function (containerAri, ari, reactions) {
            var _a;
            _this.setState({
                reactions: tslib_1.__assign(tslib_1.__assign({}, _this.state.reactions), (_a = {}, _a[containerAri + "|" + ari] = reactions, _a)),
            });
        };
        this.handleDetailedReactionResponse = function (detailedReaction) {
            ...
            _this.withReaction(function (reaction) { return (tslib_1.__assign(tslib_1.__assign({}, reaction), { users: detailedReaction.users })); })(containerAri, ari, emojiId);
        };
            ...
            _this.withReadyReaction(containerAri, ari)(function (reactionState) {
                ...
                var reactions = reactionState.reactions.map(function (reaction) {
                    if (reaction.emojiId === emojiId) {
                        ...
                        if (updated) {
                            return tslib_1.__assign(tslib_1.__assign({}, updated), { optimisticallyUpdated: true });
                        }
                    }
                    return reaction;
                });
                if (!found) {
                    ...
                    if (updated) {
                        reactions.push(tslib_1.__assign(tslib_1.__assign({}, updated), { optimisticallyUpdated: true }));
                    }
                }
        ...
        this.getReactions = batched_1.batchByKey(function (containerAri, aris) {
            _this.client
                ...
                Object.keys(value).map(function (ari) {
                    ...
                    var reactions = reactionsState && reactionsState.status === types_1.ReactionStatus.ready
    ...
    MemoryReactionsStore.prototype.setFlash = function (containerAri, ari, emojiId, flash) {
        var _a, _b;
        this.setState({
            flash: tslib_1.__assign(tslib_1.__assign({}, this.state.flash), (_a = {}, _a[containerAri + "|" + ari] = tslib_1.__assign(tslib_1.__assign({}, this.state.flash[containerAri + "|" + ari]), (_b = {}, _b[emojiId] = flash, _b)), _a)),
        });
    };
    /**
    ...
    MemoryReactionsStore.prototype.withReadyReaction = function (containerAri, ari) {
        ...
        return function (updater) {
            var reactionsState = _this.getReactionsState(containerAri, ari);
            if (reactionsState.status === types_1.ReactionStatus.ready) {
