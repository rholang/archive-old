...
var ReactionServiceClient = /** @class */ (function () {
    function ReactionServiceClient(baseUrl, sessionToken) {
        ...
        this.requestService = function (path, options) {
            return util_service_support_1.utils.requestService(_this.serviceConfig, tslib_1.__assign(tslib_1.__assign({}, options), { path: path }));
        };
...
exports.ReactionServiceClient = ReactionServiceClient;
