...
var UserPickerInternal = /** @class */ (function (_super) {
    __extends(UserPickerInternal, _super);
    function UserPickerInternal(props) {
        ...
        _this.debouncedLoadOptions = debounce(function (search) {
        ...
        _this.fireEvent = function (eventCreator) {
            ...
            if (createAnalyticsEvent) {
                createAndFireEventInElementsChannel(eventCreator.apply(void 0, __spread([_this.props, _this.state, _this.session], args)))(createAnalyticsEvent);
            }
        };
    ...
    UserPickerInternal.prototype.render = function () {
        ...
        return (React.createElement(SelectComponent, __assign({ enableAnimation: false, value: value, autoFocus: autoFocus !== undefined ? autoFocus : menuIsOpen, ref: this.handleSelectRef, isMulti: isMulti, options: this.getOptions(), styles: styles, components: components, inputValue: inputValue, menuIsOpen: menuIsOpen, isLoading: count > 0 || resolving || isLoading, loadingMessage: loadingMessage, menuPlacement: "auto", placeholder: placeholder || React.createElement(FormattedMessage, __assign({}, messages.placeholder)), addMoreMessage: addMoreMessage, classNamePrefix: "fabric-user-picker", hoveringClearIndicator: hoveringClearIndicator, appearance: appearance, isClearable: isClearable, subtle: isMulti ? false : subtle, blurInputOnSelect: !isMulti, closeMenuOnSelect: !isMulti, noOptionsMessage: noOptionsMessage, openMenuOnFocus: true, isDisabled: isDisabled, isFocused: menuIsOpen, backspaceRemovesValue: isMulti, filterOption: null, clearValueLabel: clearValueLabel, menuMinWidth: menuMinWidth, menuPortalTarget: menuPortalTarget, disableInput: disableInput || isDisabled, instanceId: fieldId, inputId: inputId, onChange: this.handleChange, onFocus: this.handleFocus, onBlur: this.handleBlur, onClose: this.handleClose, onInputChange: this.handleInputChange, onClearIndicatorHover: this.handleClearIndicatorHover, onKeyDown: this.handleKeyDown }, pickerProps)));
    };
