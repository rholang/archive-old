...
var UserPicker = /** @class */ (function (_super) {
    ...
    UserPicker.prototype.render = function () {
        ...
        return (React.createElement(BaseUserPicker, __assign({}, this.props, { width: width, SelectComponent: SelectComponent, styles: getStyles(width), components: getComponents(isMulti, anchor), pickerProps: pickerProps })));
    };
