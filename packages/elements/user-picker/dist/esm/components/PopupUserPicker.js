...
var PopupUserPicker = /** @class */ (function (_super) {
    __extends(PopupUserPicker, _super);
    ...
    PopupUserPicker.prototype.render = function () {
        ...
        return (React.createElement(BaseUserPicker, __assign({}, this.props, { SelectComponent: PopupSelect, width: width, styles: styles, components: getPopupComponents(!!popupTitle), pickerProps: getPopupProps(width, target, this.handleFlipStyle, popupTitle, boundariesElement) })));
    };
