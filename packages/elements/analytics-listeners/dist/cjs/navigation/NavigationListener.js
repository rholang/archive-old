...
var NavigationListener = /** @class */ (function (_super) {
    ...
    NavigationListener.prototype.render = function () {
        return (React.createElement(analytics_next_1.AnalyticsListener, { onEvent: this.listenerHandler, channel: types_1.FabricChannel.navigation }, this.props.children));
    };
