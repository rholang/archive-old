...
var AnalyticsViewerWrapper = styled.ul(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  list-style: none;\n  padding: 0;\n  & li:nth-child(even) {\n    background-color: #fff;\n  }\n  & li:nth-child(odd) {\n    background-color: #eee;\n  }\n"], ["\n  list-style: none;\n  padding: 0;\n  & li:nth-child(even) {\n    background-color: #fff;\n  }\n  & li:nth-child(odd) {\n    background-color: #eee;\n  }\n"])));
var renderEventViewer = function (event, index, events) { return React.createElement(EventViewer, __assign({ key: events.length - index }, event)); };
