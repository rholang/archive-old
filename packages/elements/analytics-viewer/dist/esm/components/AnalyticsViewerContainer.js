...
var ChildrenWrapper = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  flex-grow: 1;\n"], ["\n  flex-grow: 1;\n"])));
var StyledAnalyticsViewer = styled(AnalyticsViewer)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  flex-grow: 0;\n  flex-shrink: 1;\n  height: 100px;\n  overflow-y: scroll;\n"], ["\n  flex-grow: 0;\n  flex-shrink: 1;\n  height: 100px;\n  overflow-y: scroll;\n"])));
var AnalyticsViewerContainer = /** @class */ (function (_super) {
    __extends(AnalyticsViewerContainer, _super);
    function AnalyticsViewerContainer(props) {
        var _this = _super.call(this, props) || this;
        _this.handleOnEvent = function (event, channel) {
            _this.setState(function (state) { return ({
                events: __spread([{ event: event, channel: channel }], state.events),
            }); });
        };
        _this.state = {
            events: [],
