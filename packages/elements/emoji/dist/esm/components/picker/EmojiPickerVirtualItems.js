...
var SearchItem = /** @class */ (function (_super) {
    ...
    function SearchItem(props) {
        ...
        _this.renderItem = function () { return React.createElement(EmojiPickerListSearch, __assign({}, _this.props)); };
        return _this;
    }
    return SearchItem;
}(AbstractItem));
...
var EmojisRowItem = /** @class */ (function (_super) {
    __extends(EmojisRowItem, _super);
    function EmojisRowItem(props) {
        var _this = _super.call(this, props, sizes.emojiRowHeight) || this;
        _this.renderItem = function () { return React.createElement(EmojiPickerEmojiRow, __assign({}, _this.props)); };
        return _this;
    }
...
var CategoryHeadingItem = /** @class */ (function (_super) {
    __extends(CategoryHeadingItem, _super);
    function CategoryHeadingItem(props) {
        var _this = _super.call(this, props, sizes.categoryHeadingHeight) || this;
        _this.renderItem = function () { return React.createElement(EmojiPickerCategoryHeading, __assign({}, _this.props)); };
        return _this;
    }
