        ...
        if (categories) {
            categoriesSection = (React.createElement("ul", null, categories.map(function (categoryId) {
                ...
                return (React.createElement("li", { key: category.id },
                    React.createElement(FormattedMessage, __assign({}, messages[category.name]), function (categoryName) { return (React.createElement("button", { "data-category-id": category.id, className: classNames(categoryClasses), onClick: onClick, title: categoryName },
