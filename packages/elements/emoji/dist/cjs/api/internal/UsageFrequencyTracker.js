...
var DuplicateLimitedQueue_1 = tslib_1.__importDefault(require("../../util/DuplicateLimitedQueue"));
var StoredDuplicateLimitedQueue_1 = tslib_1.__importDefault(require("../../util/StoredDuplicateLimitedQueue"));
/**
...
var UsageFrequencyTracker = /** @class */ (function () {
    function UsageFrequencyTracker(useStorageIfPossible) {
        ...
        if (useStorageIfPossible && options.storage) {
            var queueOptions = tslib_1.__assign(tslib_1.__assign({}, options), { storage: options.storage });
