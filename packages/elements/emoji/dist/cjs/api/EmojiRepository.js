...
var EmojiRepositoryRegex_1 = require("./EmojiRepositoryRegex");
...
var Tokenizer = /** @class */ (function () {
    ...
    Tokenizer.prototype.tokenizeAsTokens = function (text) {
        var match;
        var tokens = [];
        EmojiRepositoryRegex_1.tokenizerRegex.lastIndex = 0;
        while ((match = EmojiRepositoryRegex_1.tokenizerRegex.exec(text)) !== null) {
            if (match[0]) {
                tokens.push({
                    token: match[0],
                    start: match.index,
...
var EmojiRepository = /** @class */ (function () {
    ...
    EmojiRepository.prototype.applySearchOptions = function (emojis, query, options) {
        ...
        var comparator;
        if (options.sort === types_1.SearchSort.Default) {
            comparator = Comparators_1.createSearchEmojiComparator(query, this.usageTracker.getOrder());
        }
        else if (options.sort === types_1.SearchSort.UsageFrequency) {
    ...
    EmojiRepository.prototype.initMembers = function (usageTracker) {
        this.usageTracker = usageTracker || new UsageFrequencyTracker_1.UsageFrequencyTracker();
    ...
    EmojiRepository.prototype.addToDynamicCategories = function (emoji) {
        var category = type_helpers_1.getCategoryId(emoji);
        if (constants_1.defaultCategories.indexOf(category) === -1 &&
