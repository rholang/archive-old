...
exports.getNaturalImageSize = function (dataURL) {
...
exports.parseImage = function (dataURL) {
    return new Promise(function (resolve, reject) {
        var img = new Image();
...
exports.hasFileExceededSize = function (file) {
...
exports.imageAcceptHeader = function () {
    return exports.checkWebpSupport().then(function (isWebpSupported) {
