...
export default {
    ...
    'fabric.elements.share.form.user-picker.placeholder.generic': 'Voer een naam, team of e-mailadres in',
    ...
    'fabric.elements.share.form.user-picker.validation.required': 'Selecteer minimaal één gebruiker, team of e-mailadres.',
    'fabric.elements.share.form.user-picker.no-options.domainBasedUserOnly': 'Je kunt alleen personen uitnodigen die een e-mailadres van {domains} hebben. Neem contact op met je sitebeheerder als je anderen wilt uitnodigen.',
    ...
    'fabric.elements.share.copylink.button.icon.label': "Pictogram 'Link kopiëren'",
    'fabric.elements.share.copylink.button.text': 'Link kopiëren',
    'fabric.elements.share.copied.to.clipboard.icon.label': "Pictogram 'Link gekopieerd'",
    'fabric.elements.share.copied.to.clipboard.message': 'Link naar het klembord gekopieerd',
    'fabric.elements.share.form.capabilities.info.message': 'Je uitnodiging wordt naar een beheerder gestuurd ter goedkeuring',
    'fabric.elements.share.failure.icon.label': "Pictogram 'Fout'",
    'fabric.elements.share.failure.message': 'Kan niet delen',
    'fabric.elements.share.success.message': '{object, select, blogpost {Blog post shared} bord {Board shared} kalendar {Calendar shared} concept {Draft shared} filter {Filter shared} issue {Issue shared} media {Media shared} pagina {Page shared} project {Project shared} pull-aanvraag {Pull Request shared} vraag {Question shared} rapport {Report shared} repository {Repository shared} aanvraag {Request shared} roadmap {Roadmap shared} site {Site shared} space {Space shared} overig {Link Shared}}',
    'fabric.elements.share.admin.notified.message': 'De beheerder is op de hoogte gebracht',
};
