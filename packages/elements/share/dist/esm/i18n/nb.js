...
export default {
    ...
    'fabric.elements.share.form.user-picker.placeholder.generic': 'Skriv inn navn, team eller e-post',
    ...
    'fabric.elements.share.form.user-picker.validation.required': 'Velg minst én gruppe, et team eller en e-postadresse.',
    'fabric.elements.share.form.user-picker.no-options.domainBasedUserOnly': 'Du kan bare invitere folk med e-postadresser som tilhører {domains}. Ta kontakt med sideadministratoren for å invitere andre.',
    ...
    'fabric.elements.share.copied.to.clipboard.icon.label': 'Kopiert kobling-ikon',
    'fabric.elements.share.copied.to.clipboard.message': 'Kobling er kopiert til utklippstavlen',
    'fabric.elements.share.form.capabilities.info.message': 'Invitasjonen vil bli sendt til en administrator for godkjenning',
    'fabric.elements.share.failure.icon.label': 'Feil-ikon',
    'fabric.elements.share.failure.message': 'Kan ikke deles',
    'fabric.elements.share.success.message': '{object, select, blogpost {Blog post shared} tavle {Board shared} kalender {Calendar shared} utkast {Draft shared} filter {Filter shared} sak {Issue shared} media {Media shared} side {Page shared} prosjekt {Project shared} pull-forespørsel {Pull Request shared} spørsmål {Question shared} rapport {Report shared} repositorium {Repository shared} forespørsel {Request shared} veikart {Roadmap shared} side {Site shared} område {Space shared} annet {Link Shared}}',
    'fabric.elements.share.admin.notified.message': 'Administratoren din har blitt varslet',
};
