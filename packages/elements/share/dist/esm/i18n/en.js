...
export default {
    ...
    'fabric.elements.share.form.user-picker.placeholder.generic': 'Enter name, team or email',
    ...
    'fabric.elements.share.form.user-picker.validation.required': 'Select at least one user, team or email.',
    'fabric.elements.share.form.user-picker.no-options.domainBasedUserOnly': 'You can only invite people with {domains} email addresses. Contact your site admin to invite other people.',
