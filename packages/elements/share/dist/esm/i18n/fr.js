...
export default {
    ...
    'fabric.elements.share.form.user-picker.placeholder.generic': 'Saisir un nom, une équipe ou une adresse e-mail',
    ...
    'fabric.elements.share.form.user-picker.validation.required': 'Sélectionnez au moins un utilisateur, une équipe ou une adresse e-mail.',
    'fabric.elements.share.form.user-picker.no-options.domainBasedUserOnly': "Vous pouvez uniquement inviter des personnes disposant d'une adresse e-mail {domains}. Contactez l'administrateur du site pour inviter d'autres personnes.",
    ...
    'fabric.elements.share.form.capabilities.info.message': 'Votre invitation sera envoyée à un administrateur pour approbation',
    ...
    'fabric.elements.share.admin.notified.message': 'Votre administrateur a été prévenu',
};
