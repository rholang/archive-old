...
exports.default = {
    ...
    'fabric.elements.share.form.user-picker.placeholder.generic': 'Introduceți nume, echipă sau e-mail',
    'fabric.elements.share.form.user-picker.placeholder.existingUserOnly': 'Introduceți nume sau echipă',
    'fabric.elements.share.form.user-picker.add-more': 'Introduceți mai multe',
    'fabric.elements.share.form.user-picker.validation.required': 'Selectați cel puțin un utilizator, echipă sau e-mail.',
    'fabric.elements.share.form.user-picker.no-options.domainBasedUserOnly': 'Puteți invita persoane nu mai cu adrese de e-mail {domains}. Contactați administratorul site-ului pentru a invita alte persoane.',
    'fabric.elements.share.form.user-picker.no-options.existingUserOnly': 'Nu am găsit niciun rezultat pentru „{inputValue}”.',
    'fabric.elements.share.form.user-picker.no-options.generic': 'Nu am găsit niciun rezultat pentru "{inputValue}". Invită persoane utilizând o adresă de e-mail.',
    ...
    'fabric.elements.share.form.capabilities.info.message': 'Invitația dvs. va fi transmisă unui administrator pentru aprobare',
    'fabric.elements.share.failure.icon.label': 'Pictogramă eroare',
    'fabric.elements.share.failure.message': 'Nu se poate partaja',
    'fabric.elements.share.success.message': '{object, select, blogpost {Blog post shared} panou {Board shared} calendar {Calendar shared} schiță{Draft shared} filtru {Filter shared} problemă {Issue shared} media {Media shared} pagină {Page shared} proiect {Project shared} pullrequest {Pull Request shared} întrebare {Question shared} raport {Report shared} depozit {Repository shared} solicitare {Request shared} planificare {Roadmap shared} site {Site shared} spațiu {Space shared} altele {Link Shared}}',
