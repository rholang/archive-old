...
exports.default = {
    ...
    'fabric.elements.share.form.user-picker.placeholder.generic': 'Insira um nome, uma equipe ou um e-mail',
    ...
    'fabric.elements.share.form.user-picker.validation.required': 'Selecione pelo menos um usuário, equipe ou e-mail.',
    'fabric.elements.share.form.user-picker.no-options.domainBasedUserOnly': 'Você só pode convidar pessoas com endereços de e-mail {domains}. Entre em contato com o administrador do site para convidar outras pessoas.',
    ...
    'fabric.elements.share.copied.to.clipboard.icon.label': 'Ícone de sucesso da cópia de link',
    'fabric.elements.share.copied.to.clipboard.message': 'Link copiado para a área de transferência',
    'fabric.elements.share.form.capabilities.info.message': 'Seu convite será enviado para a aprovação de um administrador',
