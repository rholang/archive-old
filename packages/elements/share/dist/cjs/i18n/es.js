...
exports.default = {
    ...
    'fabric.elements.share.form.user-picker.placeholder.generic': 'Introduce un nombre, equipo o correo electrónico',
    ...
    'fabric.elements.share.form.user-picker.validation.required': 'Selecciona al menos un usuario, equipo o correo electrónico.',
    'fabric.elements.share.form.user-picker.no-options.domainBasedUserOnly': 'Solo puedes invitar a personas con direcciones de correo electrónico de {domains}. Ponte en contacto con el administrador del sitio para invitar a otras personas.',
    ...
    'fabric.elements.share.copied.to.clipboard.icon.label': 'Copiar icono de enlace correcto',
    'fabric.elements.share.copied.to.clipboard.message': 'Enlace copiado en el portapapeles',
    'fabric.elements.share.form.capabilities.info.message': 'Se enviará tu invitación a un administrador para que la apruebe',
    ...
    'fabric.elements.share.admin.notified.message': 'Se ha notificado a tu administrador',
};
