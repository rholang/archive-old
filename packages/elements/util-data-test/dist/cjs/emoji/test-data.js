...
var utils_1 = require("@atlaskit/emoji/utils");
...
exports.mediaServiceEmoji = {
    ...
    name: 'Media example',
    fallback: ':media:',
    type: utils_2.customType,
    category: utils_2.customCategory,
    order: -2,
    representation: {
...
exports.mediaEmoji = tslib_1.__assign(tslib_1.__assign({}, exports.mediaEmojiId), { name: 'Media example', type: utils_2.customType, category: utils_2.customCategory, order: -2, representation: {
...
exports.siteEmojiWtf = {
    ...
    representation: {
        height: 120,
        width: 100,
        imagePath: 'https://pf-emoji-service--cdn.ap-southeast-2.dev.public.atl-paas.net/atlassian/wtf@4x.png',
    },
    skinVariations: [],
};
...
// EmojiDescription[]
exports.standardEmojis = utils_1.denormaliseEmojiServiceResponse(exports.standardServiceEmojis).emojis;
exports.atlassianEmojis = utils_1.denormaliseEmojiServiceResponse(exports.atlassianServiceEmojis).emojis;
