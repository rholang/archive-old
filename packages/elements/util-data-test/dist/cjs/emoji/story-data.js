...
exports.getAllEmojiData = function () {
    ...
    return {
        ...
        meta: {
            spriteSheets: tslib_1.__assign(tslib_1.__assign({}, standardSprites), atlassianSprites),
        },
    };
};
var getEmojiSet = function (name) {
    if (!emojisSets) {
        var emojis = utils_1.denormaliseEmojiServiceResponse(exports.getAllEmojiData()).emojis;
        var standardEmojis = utils_1.denormaliseEmojiServiceResponse(exports.getStandardEmojiData()).emojis;
        var atlassianEmojis = utils_1.denormaliseEmojiServiceResponse(exports.getAtlassianEmojiData()).emojis;
        var siteEmojis_1 = utils_1.denormaliseEmojiServiceResponse(exports.getSiteEmojiData())
            .emojis;
        emojisSets = new Map();
...
exports.getEmojiRepository = function () { return new resource_1.EmojiRepository(exports.getEmojis()); };
...
exports.getEmojiResourceWithStandardAndAtlassianEmojis = function (config) {
    ...
    return MockEmojiResource_1.mockEmojiResourceFactory(new resource_1.EmojiRepository(tslib_1.__spread(standardEmojis, atlassianEmojis)), config);
};
