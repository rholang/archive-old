...
export var getAllEmojiData = function () {
    ...
    return {
        emojis: __spread(standardEmojis.emojis, atlassianEmojis.emojis, siteEmojis.emojis),
        meta: {
            spriteSheets: __assign(__assign({}, standardSprites), atlassianSprites),
        },
    };
};
...
export var getEmojiResourceWithStandardAndAtlassianEmojis = function (config) {
    ...
    return mockEmojiResourceFactory(new EmojiRepository(__spread(standardEmojis, atlassianEmojis)), config);
};
