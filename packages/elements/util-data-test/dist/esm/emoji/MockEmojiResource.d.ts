...
import { EmojiProvider, UploadingEmojiProvider, EmojiRepository } from '@atlaskit/emoji/resource';
import { EmojiDescription, EmojiId, EmojiSearchResult, EmojiUpload, OptionalEmojiDescription, SearchOptions, ToneSelection, User, OptionalUser, CategoryId } from '@atlaskit/emoji/types';
