...
import { denormaliseEmojiServiceResponse, UsageFrequencyTracker, } from '@atlaskit/emoji/utils';
...
export var mediaEmoji = __assign(__assign({}, mediaEmojiId), { name: 'Media example', type: customType, category: customCategory, order: -2, representation: {
...
export var emojis = __spread(standardEmojis, atlassianEmojis, siteEmojis);
...
var TestEmojiRepository = /** @class */ (function (_super) {
    __extends(TestEmojiRepository, _super);
