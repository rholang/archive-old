import { MockMentionResource as MentionResource, createMockMentionNameResolver, } from './MockMentionResource';
...
export var resourceProviderWithTeamMentionHighlight = new MentionResource({
    minWait: 10,
    maxWait: 25,
