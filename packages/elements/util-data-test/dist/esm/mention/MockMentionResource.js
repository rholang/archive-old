...
import { AbstractMentionResource, DefaultMentionNameResolver, MentionNameStatus, } from '@atlaskit/mention/resource';
...
export var createMockMentionNameResolver = function () {
    var analyticsProps = {
        createAnalyticsEvent: function (payload) {
            ...
            return new UIAnalyticsEvent({ payload: payload });
        },
    };
...
var MockMentionResource = /** @class */ (function (_super) {
    __extends(MockMentionResource, _super);
