...
var HistoryFetcher = /** @class */ (function () {
    function HistoryFetcher(config) {
        ...
        this.historyFetched = function (status, response) {
            var e_1, _a;
            if (status.error) {
                logger_1.logError('Error fetching history,', status.statusCode);
                return;
            }
            ...
            for (var channel in response.channels) {
                ...
                try {
                    for (var messages_1 = (e_1 = void 0, tslib_1.__values(messages)), messages_1_1 = messages_1.next(); !messages_1_1.done; messages_1_1 = messages_1.next()) {
...
exports.default = HistoryFetcher;
