...
var ResourcedMentionList = /** @class */ (function (_super) {
    ...
    function ResourcedMentionList(props) {
        ...
        _this.mentionsHighlight = function () {
            ...
            return (React.createElement(TeamMentionHighlight_1.default, { createTeamLink: createTeamPath, onClose: _this.closeHighlight }));
        };
    ...
    ResourcedMentionList.prototype.UNSAFE_componentWillReceiveProps = function (nextProps) {
    ...
    ResourcedMentionList.prototype.render = function () {
        ...
        return (React.createElement(MentionList_1.default, { initialHighlightElement: this.mentionsHighlight(), mentions: mentions, resourceError: resourceError, onSelection: this.notifySelection, ref: this.handleMentionListRef }));
    };
