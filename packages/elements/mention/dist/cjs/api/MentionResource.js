...
var MentionResource = /** @class */ (function (_super) {
    ...
    MentionResource.prototype.recordMentionSelection = function (mention, contextIdentifier) {
        return this.recordSelection(mention, contextIdentifier).then(function () { }, function (error) { return logger_1.default("error recording mention selection: " + error, error); });
    };
    ...
    MentionResource.prototype.transformServiceResponse = function (result, query) {
        var mentions = result.mentions.map(function (mention) {
            ...
            return tslib_1.__assign(tslib_1.__assign({}, mention), { lozenge: lozenge, query: query });
        });
        return tslib_1.__assign(tslib_1.__assign({}, result), { mentions: mentions, query: result.query || query });
    };
...
exports.isResolvingMentionProvider = function (p) {
    return !!(p &&
