...
exports.default = {
    ...
    'fabric.elements.mentions.team.member.count': '{0, plural, one{1 tag} other{{0} tag}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one{1 tag, ideértve téged is} other{{0} tag, ideértve téged is}}',
