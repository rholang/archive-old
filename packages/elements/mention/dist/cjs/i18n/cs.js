...
exports.default = {
    ...
    'fabric.elements.mentions.team.member.count': '{0, plural, one{1 člen} few{{0} členové} many{{0} členů} other{{0} členů}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one{{0} členů včetně vás} few{{0} členů včetně vás} many{{0} členů včetně vás} other{{0} členů včetně vás}}',
