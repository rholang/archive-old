...
exports.default = {
    ...
    'fabric.elements.mentions.team.member.count': '{0, plural, one{1 člen} few{{0} členovia} many{{0} členov} other{{0} členov}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one{{0} členov vrátane vás} few{{0} členov vrátane vás} many{{0} členov vrátane vás} other{{0} členov vrátane vás}}',
