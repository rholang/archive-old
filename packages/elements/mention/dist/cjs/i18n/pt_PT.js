...
exports.default = {
    ...
    'fabric.elements.mentions.team.member.count': '{0, plural, one{1 membro} other{{0} membros}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one{{0} membros, incluindo o utilizador} other{{0} membros, incluindo o utilizador}}',
