...
exports.default = {
    ...
    'fabric.elements.mentions.team.member.count': '{0, plural, one{1 membro} other{{0} membri}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one{{0} membri, incluso te} other{{0} membri, incluso te}}',
