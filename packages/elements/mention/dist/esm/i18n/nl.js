...
export default {
    ...
    'fabric.elements.mentions.team.member.count': '{0, plural, one{1 lid} other{{0} leden}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one{{0} leden, inclusief jezelf} other{{0} leden, inclusief jezelf}}',
    ...
    'fabric.elements.mentions.team.mention.highlight.description': 'Zorg ervoor dat iedereen met één klik op de pagina terechtkomt. Heb je geen team?',
