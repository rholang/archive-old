...
export default {
    ...
    'fabric.elements.mentions.team.member.count': '{0, plural, one{1 jäsen} other{{0} jäsentä}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one{{0} jäsentä, mukaan lukien sinut} other{{0} jäsentä, mukaan lukien sinut}}',
