...
export default {
    ...
    'fabric.elements.mentions.team.member.count': '{0, plural, one{1 liige} other{{0} liiget}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one{{0} liiget, sealhulgas sina} other{{0} liiget, sealhulgas sina}}',
