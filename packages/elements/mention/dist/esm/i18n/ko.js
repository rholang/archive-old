...
export default {
    ...
    'fabric.elements.mentions.team.member.count': '{0, plural, other{구성원 {0}명}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, other{자신을 포함하여 구성원 {0}명}}',
