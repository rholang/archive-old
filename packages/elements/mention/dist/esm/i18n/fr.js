...
export default {
    ...
    'fabric.elements.mentions.team.member.count': '{0, plural, one{1 membre} other{{0} membres}}',
    'fabric.elements.mentions.team.member.count.including.you': '{0, plural, one{{0} membres (vous compris)} other{{0} membres (vous compris)}}',
