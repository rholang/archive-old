...
var Title = styled.h4(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  ", ";\n  margin-bottom: ", "px;\n  margin-top: 0;\n"], ["\n  ", ";\n  margin-bottom: ", "px;\n  margin-top: 0;\n"])), typography.h600(), gridSize() * 2);
var Text = function (_a) {
    var children = _a.children;
    return (React.createElement(TextWrapper, null,
        React.createElement(Title, null,
            React.createElement(FormattedMessage, __assign({}, messages.no_recent_activity_title))),
        children));
};
var NoRecentActivity = /** @class */ (function (_super) {
    __extends(NoRecentActivity, _super);
