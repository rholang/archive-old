...
var NoResultsState = /** @class */ (function (_super) {
    ...
    NoResultsState.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(NoResults, { key: "no-results", title: React.createElement(FormattedMessage, __assign({}, messages.no_results_title)), body: React.createElement(FormattedMessage, __assign({}, messages.no_results_body)) }),
            React.createElement(ResultItemGroup, { title: "", key: "advanced-search" },
                React.createElement(Container, null,
                    React.createElement(SearchConfluenceItem, { analyticsData: analyticsData, isCompact: true, query: query, text: React.createElement(Button, { appearance: "primary", shouldFitContainer: true },
                            React.createElement(FormattedMessage, __assign({}, messages.confluence_advanced_search_filters))), onClick: function (_a) {
                            var event = _a.event;
