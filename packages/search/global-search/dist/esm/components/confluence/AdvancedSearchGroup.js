...
var PeopleSearchWrapper = styled.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  margin-top: ", "px;\n"], ["\n  margin-top: ", "px;\n"])), math.multiply(gridSize, 3));
var AdvancedSearchGroup = /** @class */ (function (_super) {
    __extends(AdvancedSearchGroup, _super);
    ...
    AdvancedSearchGroup.prototype.render = function () {
        ...
        var text = query.length === 0 ? (React.createElement(FormattedMessage, __assign({}, messages.confluence_advanced_search))) : (React.createElement(FormattedMessage, __assign({}, messages.confluence_advanced_search_for, { values: { query: query } })));
        return [
            React.createElement(PeopleSearchWrapper, { key: "people-search" },
                React.createElement(SearchPeopleItem, { analyticsData: analyticsData, query: query, text: React.createElement(FormattedMessage, __assign({}, messages.people_advanced_search)), icon: React.createElement(Icon, { glyph: PeopleIconGlyph, size: "medium", label: "Search people" }), onClick: function (_a) {
                        var event = _a.event;
