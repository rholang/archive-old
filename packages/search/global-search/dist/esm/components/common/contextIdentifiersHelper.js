...
var mapJiraResultMap = function (resultMapperFn, keysToMap, results) {
    ...
    var nonMapped = objectKeys
        ...
        var _a;
        return (__assign(__assign({}, accum), (_a = {}, _a[key] = results[key], _a)));
    }, {});
    return Object.keys(results)
        .filter(function (key) { return keysToMap.includes(key); })
        .reduce(function (accum, resultType) {
        var _a;
        return (__assign(__assign({}, accum), (_a = {}, _a[resultType] = results[resultType].map(resultMapperFn), _a)));
    }, __assign({}, nonMapped));
};
/**
...
var mapConfluenceResultMap = function (resultMapperFn, keysToMap, results) {
    ...
    return objectKeys
        ...
        return __assign(__assign({}, accum), (_a = {}, _a[resultType] = __assign(__assign({}, results[resultType]), { items: items }), _a));
    }, __assign({}, results));
};
var attachSearchSessionIdToResult = function (searchSessionId, searchSessionIdParamName) { return function (result) {
    ...
    return __assign(__assign({}, result), { href: href.toString() });
}; };
export var attachConfluenceContextIdentifiers = function (searchSessionId, results) {
...
export var attachJiraContextIdentifiers = function (searchSessionId, results) {
    ...
    var attachJiraContext = function (result) {
        ...
        return __assign(__assign({}, result), { href: href });
    };
