...
export var getSearchResultState = function (_a) {
...
var SearchResults = /** @class */ (function (_super) {
    ...
    SearchResults.prototype.renderPreQueryState = function () {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(PreQueryState, { resultsGroups: getPreQueryGroups(), renderNoRecentActivity: renderNoRecentActivity, searchSessionId: searchSessionId, screenCounter: preQueryScreenCounter, referralContextIdentifiers: referralContextIdentifiers, renderAdvancedSearchGroup: renderAdvancedSearchGroup })));
    };
    ...
    SearchResults.prototype.render = function () {
        ...
        var searchResultState = getSearchResultState({
