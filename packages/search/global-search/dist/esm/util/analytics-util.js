...
export function buildScreenEvent(screen, timesViewed, searchSessionId, referralContextIdentifiers) {
    return {
        ...
        attributes: __assign({ subscreen: screen, timesViewed: timesViewed, searchSessionId: searchSessionId, searchReferrerId: referralContextIdentifiers &&
                ...
                referralContextIdentifiers.currentContainerId }, DEFAULT_GAS_ATTRIBUTES),
    };
}
