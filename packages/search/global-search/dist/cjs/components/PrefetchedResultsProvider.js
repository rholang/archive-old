...
var prefetchResults_1 = require("../api/prefetchResults");
exports.GlobalSearchPreFetchContext = React.createContext(undefined);
var PrefetchedResultsProvider = /** @class */ (function (_super) {
    tslib_1.__extends(PrefetchedResultsProvider, _super);
    function PrefetchedResultsProvider() {
        ...
        _this.getPrefetchedResults = function (cloudId, userId) {
            ...
            switch (context) {
                case 'confluence':
                    return prefetchResults_1.getConfluencePrefetchedData(cloudId, baseUrl);
                case 'jira':
                    return prefetchResults_1.getJiraPrefetchedData(cloudId, userId === null, baseUrl);
                default:
    ...
    PrefetchedResultsProvider.prototype.render = function () {
        ...
        return (React.createElement(exports.GlobalSearchPreFetchContext.Provider, { value: prefetchedResults }, children));
    };
    return PrefetchedResultsProvider;
}(React.Component));
exports.default = PrefetchedResultsProvider;
