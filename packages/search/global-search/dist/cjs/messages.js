...
exports.messages = react_intl_1.defineMessages({
    ...
    confluence_more_filters: {
        ...
        description: 'Text to display on button that takes the user to advanced search, which has more filtering options',
    },
    ...
    confluence_container_subtext_with_modified_date: {
        ...
        description: 'Text describing which space a given search result is from, as well as a date when it was last edited or created.',
    },
});
