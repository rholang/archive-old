...
var arrow_right_1 = tslib_1.__importDefault(require("@atlaskit/icon/glyph/arrow-right"));
...
var FilmstripView = /** @class */ (function (_super) {
    ...
    function FilmstripView(props) {
        ...
        _this.childOffsets = [];
        try {
            _this.mutationObserver = new MutationObserver(debounce_1.default(_this.handleMutation, 30, true));
        }
        catch (e) {
