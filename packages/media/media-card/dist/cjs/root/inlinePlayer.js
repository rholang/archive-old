...
var InlinePlayerBase = /** @class */ (function (_super) {
    ...
    InlinePlayerBase.prototype.render = function () {
        ...
        return (React.createElement(styled_1.InlinePlayerWrapper, { style: this.getStyle(), selected: selected, onClick: onClick, innerRef: this.divRef },
            React.createElement(media_ui_1.InactivityDetector, null, function () { return (React.createElement(media_ui_1.CustomMediaPlayer, { type: "video", src: fileSrc, isAutoPlay: true, isHDAvailable: false, onDownloadClick: _this.onDownloadClick, onFirstPlay: _this.onFirstPlay })); })));
    };
