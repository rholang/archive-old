...
var requestAuthProvider = function (authEnvironment, collectionName) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
...
exports.mediaPickerAuthProvider = function (authEnvironment) {
    if (authEnvironment === void 0) { authEnvironment = 'asap'; }
    return function (context) {
        var collectionName = (context && context.collectionName) || collectionNames_1.defaultCollectionName;
...
exports.defaultMediaPickerAuthProvider = function () {
    var auth = {
