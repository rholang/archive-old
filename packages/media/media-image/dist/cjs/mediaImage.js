...
var MediaImageInternal = /** @class */ (function (_super) {
    tslib_1.__extends(MediaImageInternal, _super);
    ...
    MediaImageInternal.prototype.UNSAFE_componentWillReceiveProps = function (_a) {
        ...
        if ((!!newIdentifier && media_client_1.isDifferentIdentifier(newIdentifier, identifier)) ||
                                ...
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 2:
                                            ...
                                            return [4 /*yield*/, mediaClient.getImage(fileId, tslib_1.__assign({ collection: collectionName }, apiConfig))];
                                        case 3:
                                            blob = _a.sent();
...
exports.MediaImageInternal = MediaImageInternal;
exports.MediaImage = media_client_1.withMediaClient(MediaImageInternal);
