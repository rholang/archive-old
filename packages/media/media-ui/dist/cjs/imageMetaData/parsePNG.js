        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return tslib_1.__importStar(require('png-chunks-extract')); })];
                case 1:
                    module_1 = _a.sent();
                    pngChunksExtract = module_1.default || module_1;
                    _a.label = 2;
                case 2: return [4 /*yield*/, util_1.fileToArrayBuffer(file)];
                case 3:
                    buffer = _a.sent();
