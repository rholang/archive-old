...
var MediaImage = /** @class */ (function (_super) {
    ...
    MediaImage.prototype.render = function () {
        ...
        */
        ...
        return (React.createElement(styled_1.ImageComponent, { draggable: false, alt: alt, style: style, onLoad: this.onImageLoad, onError: onImageError, innerRef: this.imageRef, src: dataURI, crossOrigin: crossOrigin }));
    };
