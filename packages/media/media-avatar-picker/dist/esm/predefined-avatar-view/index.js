...
var PredefinedAvatarView = /** @class */ (function (_super) {
    __extends(PredefinedAvatarView, _super);
    ...
    PredefinedAvatarView.prototype.render = function () {
        ...
        return (React.createElement(PredefinedAvatarViewWrapper, null,
            React.createElement("div", { className: "header" },
                ...
                React.createElement("div", { className: "description" }, predefinedAvatarsText || (React.createElement(FormattedMessage, __assign({}, messages.default_avatars))))),
