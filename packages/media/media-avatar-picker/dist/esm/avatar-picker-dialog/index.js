...
var AvatarPickerDialog = /** @class */ (function (_super) {
    ...
    function AvatarPickerDialog() {
        ...
        _this.setSelectedImageState = function (selectedImage) { return __awaiter(_this, void 0, void 0, function () {
            var dataURI, e_1;
        ...
        _this.headerContent = function () {
            ...
            return (React.createElement(ModalHeader, null, title || React.createElement(FormattedMessage, __assign({}, messages.upload_an_avatar))));
        };
        _this.footerContent = function () {
            ...
            return (React.createElement(ModalFooter, null,
                React.createElement(ModalFooterButtons, null,
                    React.createElement(Button, { appearance: "primary", onClick: onSaveClick, isDisabled: isDisabled }, primaryButtonText || React.createElement(FormattedMessage, __assign({}, messages.save))),
        ...
        switch (mode) {
            case Mode.Cropping:
                return (React.createElement(CroppingWrapper, null,
                    React.createElement(ImageNavigator, { imageSource: selectedImageSource, errorMessage: errorMessage, onImageLoaded: this.setSelectedImageState, onLoad: this.onImageNavigatorLoad, onRemoveImage: this.onRemoveImage, onImageUploaded: this.onImageUploaded, onImageError: this.onImageError, isLoading: isLoading }),
