...
export var cropToDataURI = function (imageElement, imageRect, cropRect, scale, imageOrientation) {
    ...
    var _k = getCanvas(destinationWidth, destinationHeight), canvas = _k.canvas, context = _k.context;
    if (!context) {
        return '';
    }
    ...
    switch (imageOrientation) {
        case 2:
            /*  Image is stored like this:
               ...
               └───────────────────┘
             */
            _a = __read([sourceRight, sourceTop], 2), sourceLeft = _a[0], sourceTop = _a[1];
            /*
            CX = Canvas Origin X
            FX = Final Origin X
        ...
        case 3:
            /*                 Left = Source Right
               ...
               └───────────────────┘
             */
            _b = __read([sourceRight, sourceBottom], 2), sourceLeft = _b[0], sourceTop = _b[1];
            /*
        ...
        case 4:
            /*    Left = Source Left
               ...
               └───────────────────┘
             */
            _c = __read([sourceLeft, sourceBottom], 2), sourceLeft = _c[0], sourceTop = _c[1];
            /*
        ...
        case 5:
            /*    Left = Source Top
               ...
               └───────────────────┘
             */
            _d = __read([sourceTop, sourceLeft], 2), sourceLeft = _d[0], sourceTop = _d[1];
            /*
        ...
        case 6:
            /*    Left = Source Top
               ...
               └───────────────────┘
             */
            _e = __read([sourceTop, sourceRight], 2), sourceLeft = _e[0], sourceTop = _e[1];
            /*
        ...
        case 7:
            /*                Left = Source Bottom
               ...
               └───────────────────┘
             */
            _f = __read([sourceBottom, sourceRight], 2), sourceLeft = _f[0], sourceTop = _f[1];
            /*
        ...
        case 8:
            /*                Left = Source Bottom
               ...
               └───────────────────┘
             */
            _g = __read([sourceBottom, sourceLeft], 2), sourceLeft = _g[0], sourceTop = _g[1];
            /*
    ...
    if (isRotated(imageOrientation)) {
        _h = __read([sourceHeight, sourceWidth], 2), sourceWidth = _h[0], sourceHeight = _h[1];
        _j = __read([
            destinationWidth,
            destinationHeight,
