...
function applyOrientation(img, canvasWidth, canvasHeight, orientation, sourceWidth, sourceHeight, destWidth, destHeight) {
    var _a = util_1.getCanvas(canvasWidth, canvasHeight), canvas = _a.canvas, context = _a.context;
    if (context) {
        switch (orientation) {
            case 2:
 ...
 */
function initialiseImagePreview(fileInfo, containerRect, maxZoom) {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            media_ui_1.getOrientation(fileInfo.file),
                            media_ui_1.loadImage(fileInfo.src),
                        ])];
                case 2:
                    result = _a.sent();
                ...
                case 4:
                    if (img) {
                        ...
                        srcRect = new media_ui_1.Rectangle(naturalWidth, naturalHeight);
                        maxRect = new media_ui_1.Rectangle(containerRect.width * maxZoom, containerRect.height * maxZoom);
...
function renderImageAtCurrentView(imageElement, viewInfo, useConstraints, useCircularClipWithActions, backgroundColor) {
    ...
    var _a = util_1.getCanvas(containerWidth, containerHeight), canvas = _a.canvas, context = _a.context;
    if (context) {
