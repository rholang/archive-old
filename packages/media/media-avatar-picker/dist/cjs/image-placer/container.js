...
var ImagePlacerContainer = /** @class */ (function (_super) {
    ...
    function ImagePlacerContainer() {
        ...
        _this.onMouseDown = function (e) {
            ...
            _this.dragClientStart = new media_ui_1.Vector2(e.clientX, e.clientY);
            _this.props.onDragStart();
        };
        _this.onTouchStart = function (e) {
            if (e.touches && e.touches.length >= 1) {
                var touch = e.touches[0];
                _this.dragClientStart = new media_ui_1.Vector2(touch.clientX, touch.clientY);
                _this.props.onDragStart();
            }
        };
        _this.onMouseMove = function (e) {
            ...
            if (dragClientStart) {
                var delta = new media_ui_1.Vector2(e.clientX - dragClientStart.x, e.clientY - dragClientStart.y);
        ...
        _this.onTouchMove = function (e) {
            ...
            if (e.touches && e.touches.length >= 1) {
                ...
                if (touch && dragClientStart) {
                    var delta = new media_ui_1.Vector2(touch.clientX - dragClientStart.x, touch.clientY - dragClientStart.y);
                    _this.props.onDragMove(delta);
                }
            }
        };
    ...
    ImagePlacerContainer.prototype.UNSAFE_componentWillMount = function () {
        if (this.isTouch) {
    ...
    ImagePlacerContainer.prototype.render = function () {
        ...
        return (React.createElement(styled_1.ContainerWrapper, { width: width, height: height, margin: margin, onMouseDown: onMouseDown, onTouchStart: onTouchStart, onWheel: this.onWheel }, children));
    };
    return ImagePlacerContainer;
}(React.Component));
exports.ImagePlacerContainer = ImagePlacerContainer;
