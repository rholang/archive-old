...
exports.DEFAULT_MAX_ZOOM = 4;
exports.DEFAULT_MARGIN = 28;
exports.DEFAULT_CONTAINER_SIZE = 200;
exports.DEFAULT_ZOOM = 0;
exports.DEFAULT_ORIGIN_X = 0;
exports.DEFAULT_ORIGIN_Y = 0;
exports.DEFAULT_USE_CONSTRAINTS = true;
exports.DEFAULT_USE_CIRCULAR = false; /* whether or not to apply a circular margin to image while positioning */
exports.DEFAULT_USE_CIRCULAR_CLIP_WITH_ACTIONS = false; /* whether or not to apply a circular clip when rendering via actions */
exports.DEFAULT_BACKGROUND_COLOR = 'transparent';
exports.defaultProps = {
    containerWidth: exports.DEFAULT_CONTAINER_SIZE,
    containerHeight: exports.DEFAULT_CONTAINER_SIZE,
    margin: exports.DEFAULT_MARGIN,
    zoom: exports.DEFAULT_ZOOM,
    maxZoom: exports.DEFAULT_MAX_ZOOM,
    originX: exports.DEFAULT_ORIGIN_X,
    originY: exports.DEFAULT_ORIGIN_Y,
    useConstraints: exports.DEFAULT_USE_CONSTRAINTS,
    isCircular: exports.DEFAULT_USE_CIRCULAR,
    useCircularClipWithActions: exports.DEFAULT_USE_CIRCULAR_CLIP_WITH_ACTIONS,
    backgroundColor: exports.DEFAULT_BACKGROUND_COLOR,
};
var ImagePlacer = /** @class */ (function (_super) {
    tslib_1.__extends(ImagePlacer, _super);
    function ImagePlacer() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.imageSourceRect = new media_ui_1.Rectangle(0, 0); /* original size of image (un-scaled) */
        _this.state = {
            imageWidth: 0,
            imageHeight: 0,
        ...
        _this.toCanvas = function () {
            ...
            return imageProcessor_1.renderImageAtCurrentView(imageElement, viewInfo, useConstraints, useCircularClipWithActions, backgroundColor);
        };
        ...
        _this.toFile = function () {
            return media_ui_1.dataURItoFile(_this.toDataURL());
        };
        /* image has loaded */
        _this.onImageLoad = function (imageElement, width, height) {
            var onImageChange = _this.props.onImageChange;
            _this.imageSourceRect = new media_ui_1.Rectangle(width, height);
        ...
        _this.onDragStart = function () {
            ...
            _this.setState({
                dragOrigin: new media_ui_1.Vector2(originX, originY),
            });
        };
        /* drag within container has started */
    ...
    Object.defineProperty(ImagePlacer.prototype, "containerRectWithMargins", {
        ...
        get: function () {
            ...
            return new media_ui_1.Rectangle(containerWidth + margin * 2, containerHeight + margin * 2);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ImagePlacer.prototype, "containerRect", {
        ...
        get: function () {
            ...
            return new media_ui_1.Rectangle(containerWidth, containerHeight);
        },
        enumerable: true,
        configurable: true
    });
    ...
    ImagePlacer.prototype.calcImageBounds = function (zoom) {
        ...
        return new media_ui_1.Bounds(x, y, width, height);
    };
    Object.defineProperty(ImagePlacer.prototype, "visibleBounds", {
        ...
        get: function () {
            var _a = this.props, containerWidth = _a.containerWidth, containerHeight = _a.containerHeight, margin = _a.margin;
            return new media_ui_1.Bounds(margin, margin, containerWidth, containerHeight);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ImagePlacer.prototype, "sourceBounds", {
        ...
        get: function () {
            ...
            return new media_ui_1.Bounds(originX, originY, cornerX - originX, cornerY - originY);
        },
        enumerable: true,
        configurable: true
    });
    ImagePlacer.prototype.UNSAFE_componentWillMount = function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, media_ui_1.getFileInfo(nextSrc)];
                    case 1:
                        fileInfo = _b.sent();
                        _b.label = 2;
                    case 2:
                        if (!(typeof nextSrc === 'string' && nextSrc !== currentSrc)) return [3 /*break*/, 4];
                        return [4 /*yield*/, media_ui_1.getFileInfoFromSrc(nextSrc)];
                    case 3:
                        fileInfo = _b.sent();
                        _b.label = 4;
                    case 4:
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, imageProcessor_1.initialiseImagePreview(fileInfo, this.containerRect, maxZoom)];
                    case 1:
                        previewInfo = _a.sent();
                        if (previewInfo) {
                            width = previewInfo.width, height = previewInfo.height;
                            this.imageSourceRect = new media_ui_1.Rectangle(width, height);
    ...
    ImagePlacer.prototype.zoomToFit = function () {
        var _a = this.state, imageWidth = _a.imageWidth, imageHeight = _a.imageHeight;
        var _b = constraints_1.zoomToFit(imageWidth, imageHeight, this.visibleBounds), fittedWidth = _b.width, fittedHeight = _b.height;
        this.setState({
    ...
    ImagePlacer.prototype.applyConstraints = function () {
        ...
        var delta = constraints_1.applyConstraints(useConstraints, imageBounds, visibleBounds);
        this.setState({
    ...
    ImagePlacer.prototype.setZoom = function (newZoom) {
        ...
        var origin = new media_ui_1.Vector2(originX + deltaX, originY + deltaY);
        this.setState({
            zoom: newZoom,
            originX: origin.x,
            originY: origin.y,
    ...
    ImagePlacer.prototype.transformVisibleBoundsToImageCoords = function (visibleBoundsX, visibleBoundsY) {
        ...
        return constraints_1.transformVisibleBoundsToImageCoords(visibleBoundsX, visibleBoundsY, imageSourceRect, imageBounds, visibleBounds);
    };
    /* make it so */
    ImagePlacer.prototype.render = function () {
        ...
        return (React.createElement(styled_1.ImagePlacerWrapper, { backgroundColor: backgroundColor },
            React.createElement(container_1.ImagePlacerContainer, { width: containerWidth, height: containerHeight, margin: margin, onDragStart: this.onDragStart, onDragMove: this.onDragMove, onWheel: this.onWheel }, errorMessage ? (React.createElement(styled_1.ImagePlacerErrorWrapper, null, onRenderError ? onRenderError(errorMessage) : errorMessage)) : (React.createElement("div", null,
                React.createElement(image_1.ImagePlacerImage, { src: imgSrc, x: imageBounds.x, y: imageBounds.y, width: imageBounds.width, height: imageBounds.height, onLoad: this.onImageLoad, onError: this.onImageError }),
                React.createElement(margin_1.Margin, { width: containerWidth, height: containerHeight, circular: isCircular, size: margin }))))));
    };
    ImagePlacer.defaultProps = exports.defaultProps;
    return ImagePlacer;
}(React.Component));
exports.ImagePlacer = ImagePlacer;
