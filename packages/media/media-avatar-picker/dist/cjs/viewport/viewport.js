 ...
 */
exports.MAX_SCALE = 1.5;
exports.DEFAULT_WIDTH = 100;
exports.DEFAULT_HEIGHT = 100;
exports.DEFAULT_MARGIN = 10;
exports.DEFAULT_INNER_WIDTH = exports.DEFAULT_WIDTH - exports.DEFAULT_MARGIN * 2;
exports.DEFAULT_INNER_HEIGHT = exports.DEFAULT_HEIGHT - exports.DEFAULT_MARGIN * 2;
/**
...
var Viewport = /** @class */ (function () {
    function Viewport(width, height, margin) {
        if (width === void 0) { width = exports.DEFAULT_WIDTH; }
        if (height === void 0) { height = exports.DEFAULT_HEIGHT; }
        if (margin === void 0) { margin = exports.DEFAULT_MARGIN; }
        this.width = width;
        this.height = height;
        this.margin = margin;
        this.itemSourceRect = new media_ui_1.Rectangle(0, 0);
        this.dragStartPos = new media_ui_1.Vector2(0, 0);
        this.itemBounds = new media_ui_1.Bounds(0, 0, 0, 0);
        this.orientation = 1;
    ...
    Viewport.prototype.applyConstraints = function () {
        ...
        this.itemBounds = new media_ui_1.Bounds(x, y, itemBounds.width, itemBounds.height);
    };
    Object.defineProperty(Viewport.prototype, "innerBounds", {
        get: function () {
            var _a = this, margin = _a.margin, width = _a.width, height = _a.height;
            return new media_ui_1.Bounds(margin, margin, width - margin * 2, height - margin * 2);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Viewport.prototype, "outerBounds", {
        get: function () {
            return new media_ui_1.Bounds(0, 0, this.width, this.height);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Viewport.prototype, "visibleSourceBounds", {
        get: function () {
            ...
            return new media_ui_1.Bounds(origin.x, origin.y, corner.x - origin.x, corner.y - origin.y);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Viewport.prototype, "itemSourceBounds", {
        get: function () {
            ...
            return new media_ui_1.Bounds(0, 0, itemSourceRect.width, itemSourceRect.height);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(Viewport.prototype, "maxScale", {
        get: function () {
            ...
            if (minSize <= innerBounds.width) {
                return exports.MAX_SCALE;
            }
            else {
                return (minSize * exports.MAX_SCALE) / innerBounds.width;
            }
        },
        enumerable: true,
        configurable: true
    ...
    Object.defineProperty(Viewport.prototype, "maxItemViewRect", {
        get: function () {
            ...
            return new media_ui_1.Rectangle(maxWidth, maxHeight);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Viewport.prototype.setItemSize = function (width, height) {
        this.itemSourceRect = new media_ui_1.Rectangle(width, height);
        this.zoomToFit();
        return this;
    };
    ...
    Viewport.prototype.setScale = function (scale) {
        ...
        if (scale <= 1) {
            ...
            var scaledBounds = new media_ui_1.Bounds(itemBounds.x, itemBounds.y, width, height);
            ...
            this.itemBounds = new media_ui_1.Bounds(left, top_1, scaledBounds.width, scaledBounds.height);
    ...
    Viewport.prototype.viewToLocalPoint = function (viewX, viewY) {
        ...
        return new media_ui_1.Vector2(itemSourceRect.width * localX, itemSourceRect.height * localY);
    };
    return Viewport;
}());
