...
var bitmapFragment_1 = require("./bitmapFragment");
    ...
    Bitmap.prototype.splitToFragments = function (img, gl, supplementaryCanvas, maxSize) {
        ...
        for (var x = 0; x < width; x += maxSize) {
            for (var y = 0; y < height; y += maxSize) {
                ...
                var fragment = new bitmapFragment_1.BitmapFragment(gl, x, y, fragmentWidth, fragmentHeight, img, supplementaryCanvas);
