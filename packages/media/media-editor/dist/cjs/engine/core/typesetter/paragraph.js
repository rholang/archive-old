...
var cursorPositions_1 = require("./cursorPositions");
...
var Paragraph = /** @class */ (function () {
    ...
    Paragraph.prototype.createFragments = function () {
        ...
        return textRenderer_1.renderText(this.fragments, tslib_1.__assign({ text: text,
            direction: direction,
    ...
    Paragraph.prototype.calculateCursorPositions = function () {
        ...
        rootDiv.style.font = fontInfo_1.FontInfo.getFontStyle(fontSize);
        rootDiv.style.direction = direction;
        this.cursorPositions = cursorPositions_1.getCursorPositions(text, direction, rootDiv);
