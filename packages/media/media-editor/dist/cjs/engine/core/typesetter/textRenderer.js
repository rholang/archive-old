...
exports.renderText = function (fragments, config) {
    ...
    normalTextures.forEach(function (generatedNormal, index) {
        ...
        if (normal && stroke) {
            fragments.push(new fragment_1.Fragment(gl, normal, stroke, position));
        }
    });
    return true;
};
...
var measureText = function (config) {
    ...
    context.font = fontInfo_1.FontInfo.getFontStyle(fontSize);
