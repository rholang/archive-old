...
var DefaultKeyboardInput = /** @class */ (function () {
    function DefaultKeyboardInput(hTextArea, supplementaryCanvas, textHelperDiv) {
        ...
        this.characterPressed = new signal_1.Signal();
        this.inputCommand = new signal_1.Signal();
    ...
    DefaultKeyboardInput.prototype.passText = function () {
        ...
        if (text) {
            util_1.getUtf32Codes(text).forEach(function (code) { return _this.characterPressed.emit(code); });
            this.hTextArea.value = '';
        }
    };
    return DefaultKeyboardInput;
}());
exports.DefaultKeyboardInput = DefaultKeyboardInput;
