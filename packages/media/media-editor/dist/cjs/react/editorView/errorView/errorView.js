...
var ErrorView = /** @class */ (function (_super) {
    ...
    ErrorView.prototype.render = function () {
        return (React.createElement(styles_2.EditorContainer, null,
            React.createElement(styles_1.ErrorPopup, null,
                React.createElement(styles_1.ErrorIconWrapper, null, icons_1.errorIcon),
                React.createElement(styles_1.ErrorMessage, null, this.props.message),
                React.createElement(styles_1.ErrorHint, null, this.renderHint()),
    ...
    ErrorView.prototype.renderTryAgainButton = function () {
        var _a = this.props, onRetry = _a.onRetry, formatMessage = _a.intl.formatMessage;
        if (onRetry) {
            return (React.createElement(styles_1.ErrorButton, { appearance: "primary", onClick: onRetry }, formatMessage(media_ui_1.messages.try_again)));
        }
        return null;
    };
    ErrorView.prototype.renderCancelButton = function () {
        ...
        return (React.createElement(styles_1.ErrorButton, { appearance: "subtle", onClick: onCancel }, formatMessage(message)));
    };
    return ErrorView;
}(react_1.Component));
