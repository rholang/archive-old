...
var Engine = /** @class */ (function () {
    ...
    Engine.prototype.subscribeToComponentsSignals = function () {
        ...
        toolbar.colorChanged.listen(function (color) {
            return _this.veCall('update color', function (ve) { return ve.setColor(hexToRgb(color)); });
        });
    ...
    Engine.prototype.initModule = function () {
        ...
        this.module.handleShapeParametersChanged = function (red, green, blue, lineWidth, addShadow) {
            toolbar.updateByCore({
                color: rgbToHex({ red: red, green: green, blue: blue }),
                lineWidth: lineWidth,
                addShadow: addShadow,
            });
        };
        ...
        var typesetter = new BrowserTypesetter(__assign({ 
    ...
    Engine.prototype.createVeEngine = function () {
        ...
        var initialParameters = {
            ...
            backgroundColor: __assign({ alpha: maxColorChannel }, drawingArea.backgroundColor),
