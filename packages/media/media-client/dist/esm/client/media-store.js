...
var extendImageParams = function (params, fetchMaxRes) {
    ...
    return __assign(__assign(__assign({}, defaultImageOptions), params), (fetchMaxRes ? { width: 4096, height: 4096 } : {}));
};
var jsonHeaders = {
...
var MediaStore = /** @class */ (function () {
    function MediaStore(config) {
        ...
        this.getFileBinaryURL = function (id, collectionName) { return __awaiter(_this, void 0, void 0, function () {
            var auth;
            return __generator(this, function (_a) {
                switch (_a.label) {
