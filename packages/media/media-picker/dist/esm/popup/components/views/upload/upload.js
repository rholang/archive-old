...
var StatelessUploadView = /** @class */ (function (_super) {
    ...
    StatelessUploadView.prototype.uploadingFilesCards = function () {
        ...
        return itemsKeys.map(function (key) {
            ...
            return {
                key: id,
                el: (React.createElement(Card, { mediaClientConfig: mediaClient.config, identifier: identifier, dimensions: cardDimension, selectable: true, selected: selected, onClick: onClick, actions: actions })),
            };
        });
    };
    StatelessUploadView.prototype.recentFilesCards = function () {
        ...
        return items.map(function (item) {
            ...
            return {
                ...
                el: (React.createElement(Card, { mediaClientConfig: mediaClient.config, identifier: {
                        id: id,
                        mediaItemType: 'file',
