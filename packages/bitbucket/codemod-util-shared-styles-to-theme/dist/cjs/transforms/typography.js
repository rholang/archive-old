...
exports.default = gridSizeUnitlessTransform;

var _utils = require("../utils");

function gridSizeUnitlessTransform(root, j) {
  ...
  (0, _utils.addNamedImport)(root, j, '@atlaskit/theme', 'typography', localName, sharedStylesImport);
  (0, _utils.removeNamedImport)(root, j, '@atlaskit/util-shared-styles', 'akTypographyMixins', typogImportSpecifier);
  return root;
}