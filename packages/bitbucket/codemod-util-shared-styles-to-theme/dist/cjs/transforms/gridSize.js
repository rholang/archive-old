...
exports.default = gridSize;

var _utils = require("../utils");

function gridSize(root, j) {
  ...
  localName = (0, _utils.addNamedImport)(root, j, '@atlaskit/theme', 'gridSize', localName, sharedStylesImport); // Convert uses of the old akBorderRadius to template `${akBorderRadius()}px`
  ...
  (0, _utils.removeNamedImport)(root, j, '@atlaskit/util-shared-styles', 'akGridSize', importSpecifier);
  return root;
}