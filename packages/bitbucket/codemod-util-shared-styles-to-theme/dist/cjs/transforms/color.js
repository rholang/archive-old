...
function colorTransform(root, j) {
  ...
  (0, _utils.addNamedImport)(root, j, '@atlaskit/theme', 'colors', 'colors', sharedStylesImport); // Remove util shared styles if no named imports
