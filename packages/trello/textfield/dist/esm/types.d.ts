...
export declare type TextFieldAppearance = 'default' | 'none' | 'transparent' | 'blue';
export declare type TextFieldStyleState = 'idle' | 'hover' | 'focus';
export declare type TextFieldStyleAppearance = TextFieldAppearance & 'disabled';
export declare type TextFieldThemeStyles = {
    container?: TextFieldStyleProps;
    input?: TextFieldStyleProps;
};
export declare type TextFieldStyleMap = string | Object | {
    [index: string]: string;
} | {
...
export declare type TextFieldStyleProps = {
...
export declare type TextFieldThemeProps = {
...
export declare type TextFieldProps = TextFieldThemeProps & {
