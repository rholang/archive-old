...
var DropdownList = /** @class */ (function (_super) {
    ...
    DropdownList.prototype.render = function () {
        ...
        var footNote = visibleSites.length === accessibleSites.length && (React.createElement(Styled.AccessibleSitesListFootnote, null,
            React.createElement(FormattedMessage, __assign({}, overviewMessages.paragraphLoseAccessFootnote))));
        var toggleExpand = accessibleSites.length > COLLAPSED_LIST_SITE_COUNT && (React.createElement(Styled.ButtonWrapper, null,
            React.createElement(Button, { onClick: isExpanded ? this.hideDropdownList : this.showDropdownList, appearance: "link", spacing: "none" }, isExpanded ? (React.createElement(FormattedMessage, __assign({}, dropDownListMessages.collapseButton))) : (React.createElement(FormattedMessage, __assign({}, dropDownListMessages.expandButton, { values: { num: accessibleSites.length - 3 } }))))));
