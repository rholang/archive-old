 ...
 * @return {object}
 */
exports.modifyResponse = function (response) {
    var data = tslib_1.__assign({}, response.User);
...
var requestService = function (serviceUrl, cloudId, userId) {
    ...
    return fetch(new Request(serviceUrl, {
        ...
        return response.json().then(function (json) {
            ...
            return Promise.resolve(exports.modifyResponse(json.data));
        });
    });
};
var ProfileCardClient = /** @class */ (function () {
    function ProfileCardClient(config) {
        ...
        this.config = tslib_1.__assign(tslib_1.__assign({}, defaults), config);
        ...
        this.cache =
            !this.config.cacheMaxAge || !this.config.cacheSize
                ? null
                : new lru_fast_1.LRUCache(this.config.cacheSize);
    }
...
exports.default = ProfileCardClient;
