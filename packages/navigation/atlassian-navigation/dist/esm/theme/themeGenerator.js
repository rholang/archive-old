...
var generateCSSStates = function (colors) {
    ...
    var backgroundColorRgb = chromatism.convert(backgroundColor).rgb;
    var contrastBackgroundColorRgb = chromatism.contrastRatio(backgroundColor)
        .rgb;
    var colorRgb = chromatism.convert(color).rgb;
    return {
        active: {
...
export var generateTheme = function (args) {
    ...
    var backgroundColorRgb = chromatism.convert(primaryColors.backgroundColor)
        .rgb;
    var contrastBackgroundColor = chromatism.contrastRatio(backgroundColorRgb);
