...
export const loadAtlassianSwitcher = () =>
  import(/* webpackChunkName: "@ak-switcher-chunk-atlassian-switcher" */ './atlassian-switcher');

export const loadJiraSwitcher = () =>
  import(/* webpackChunkName: "@ak-switcher-chunk-jira-switcher" */ './jira-switcher');

export const loadConfluenceSwitcher = () =>
  import(/* webpackChunkName: "@ak-switcher-chunk-confluence-switcher" */ './confluence-switcher');

export const loadGenericSwitcher = () =>
  import(/* webpackChunkName: "@ak-switcher-chunk-generic-switcher" */ './generic-switcher');
