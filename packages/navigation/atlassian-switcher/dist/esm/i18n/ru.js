...
export default {
    ...
    'fabric.atlassianSwitcher.errorText': 'Мы стараемся отслеживать все ошибки. Если обновление страницы не поможет, обязательно сообщите нам об этом.',
    'fabric.atlassianSwitcher.errorImageAltText': 'Несколько людей и один робот уже всё чинят.',
    'fabric.atlassianSwitcher.errorTextNetwork': 'Не удалось загрузить список. Обновите страницу и повторите попытку.',
    'fabric.atlassianSwitcher.errorTextLoggedOut': 'Вы вышли из системы. Выполните вход еще раз.',
