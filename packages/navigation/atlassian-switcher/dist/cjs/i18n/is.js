...
exports.default = {
    ...
    'fabric.atlassianSwitcher.errorText': 'Við fylgjumst með þessum villum en þér er velkomið að hafa samband við okkur ef þetta lagast ekki við endurnýjun.',
    'fabric.atlassianSwitcher.errorImageAltText': 'Bilað vélmenni og fjöldi aðila sem eru önnum kafnir við að laga það.',
    'fabric.atlassianSwitcher.errorTextNetwork': 'Ekki tókst að hlaða þennan lista. Endurhladdu síðuna og reyndu aftur.',
    'fabric.atlassianSwitcher.errorTextLoggedOut': 'Þú hefur verið skráður út. Vinsamlegast skráðu þig inn aftur.',
