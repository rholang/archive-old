...
exports.RELEASE_RESOLVED_PROMISE_DELAY = 5000;
 ...
 */
exports.withCached = function (fn) {
    ...
    var cached = function () {
        ...
        var cacheKey = getCacheKey.apply(void 0, tslib_1.__spread(args));
    ...
    var execute = function () {
        ...
        var maybePromise = fn.apply(void 0, tslib_1.__spread(args));
        promiseCache.set(cacheKey, maybePromise);
        if (isPromise(maybePromise)) {
            maybePromise
                .then(function (result) {
                resultCache.set(cacheKey, result);
                setTimeout(function () { return promiseCache.delete(cacheKey); }, exports.RELEASE_RESOLVED_PROMISE_DELAY);
            })
                .catch(function () {
