...
var intl_provider_1 = tslib_1.__importDefault(require("../components/intl-provider"));
var messages = react_intl_1.defineMessages({
    ...
    productDescriptionJiraServiceDesk: {
        ...
        description: 'Text displayed under Jira Service Desk product recommendation.',
    },
...
exports.SwitchToTooltipText = (React.createElement(intl_provider_1.default, null,
    React.createElement(formatted_message_1.default, tslib_1.__assign({}, messages.switchToTooltip))));
