...
export default function asExperiment(experimentComponentMap, experimentKey, callbacks, LoadingComponent) {
  ...
  function (_Component) {
    ...
    function ExperimentSwitch() {
      ...
      _defineProperty(_assertThisInitialized(_this), "onReceiveContext", function (experiments, options) {
    ...
    _createClass(ExperimentSwitch, [{
      ...
      value: function render() {
        ...
        return React.createElement(ExperimentConsumer, null, function (_ref) {
