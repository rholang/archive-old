...
export var ArticleBody = function (props) {
    var iframeRef = useRef(null);
    var _a = __read(useState('auto'), 2), articleHeight = _a[0], setArticleHeight = _a[1];
    /**
     * Set article height
     */
    ...
    useEffect(function () {
         ...
         */
        var onWindowResize = debounce(function () { return resizeIframe(iframeRef); }, 500);
    ...
    return props.body ? (React.createElement(ArticleFrame, { style: { height: articleHeight }, ref: iframeRef, sandbox: "allow-scripts allow-same-origin" })) : null;
};
