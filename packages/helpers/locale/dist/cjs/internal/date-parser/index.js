...
var INVARIANT_DATE = utils_1.toDate(INVARIANT);
 ...
 * @returns DateParser
 */
exports.createDateParser = function (locale) {
    ...
    return function (date) {
        ...
        var normalizedDate = utils_1.normalizeDate(extractedDate);
        if (!utils_1.isValid(normalizedDate)) {
            return INVALID_DATE;
        }
        return utils_1.toDate(normalizedDate);
    };
};
