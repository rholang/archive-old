...
exports.toDateObj = function (date) { return ({
...
exports.getDaysInMonth = function (year, month) {
    ...
    if (month === 2 && exports.isLeapYear(year)) {
        return 29;
    }
...
exports.isValid = function (date) {
    ...
    var daysInMonth = exports.getDaysInMonth(year, month);
...
exports.normalizeDate = function (date) {
    var now = exports.toDateObj(new Date());
    var year = date.year, month = date.month, day = date.day;
