...
import { ExternalMediaAttributes, MediaAttributes, MentionAttributes, MediaSingleAttributes, CellAttributes, LinkAttributes, TableAttributes, CardAttributes, BreakoutMarkAttrs, AlignmentAttributes, IndentationMarkAttributes, AnnotationMarkAttributes } from '@atlaskit/adf-schema';
...
export declare const annotation: (attrs: AnnotationMarkAttributes) => (...content: BuilderContent[]) => (schema: Schema<any, any>) => RefsNode[];
...
export declare const builderEval: (data: string) => any;
