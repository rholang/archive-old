...
exports.customInsertMenuItems = [
    {
        content: 'Import',
        value: { name: 'import' },
        tooltipDescription: 'import',
        tooltipPosition: 'right',
        elemBefore: React.createElement(code_1.default, { label: "dev" }),
        onClick: function (editorActions) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var input;
    ...
    },
    {
        ...
        tooltipPosition: 'right',
        elemBefore: React.createElement(code_1.default, { label: "Inline macro (EH)" }),
    ...
    },
    {
        ...
        tooltipPosition: 'right',
        elemBefore: React.createElement(code_1.default, { label: "Block macro (EH)" }),
    ...
    },
    {
        ...
        tooltipPosition: 'right',
        elemBefore: React.createElement(code_1.default, { label: "Bodied macro (EH)" }),
    ...
    },
    {
        ...
        tooltipPosition: 'right',
        elemBefore: React.createElement(code_1.default, { label: "Bodied macro (NON-EH)" }),
        onClick: function (editorActions) {
            editorActions.replaceSelection({
                type: 'bodiedExtension',
                attrs: {
        ...
        onClick: function (editorActions) {
            ...
            var openMacroBrowser = new Promise(function (resolve) {
                window.setTimeout(function () {
                    resolve(mock_extension_data_1.bodiedExtensionData[0]);
                }, 1000);
            });
