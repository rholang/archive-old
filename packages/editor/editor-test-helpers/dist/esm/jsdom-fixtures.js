...
function getImageDimensions(src) {
    if (src.length) {
        ...
        var _a = __read(filename.split('.', 2), 1), dimensions = _a[0];
        var _b = __read(dimensions.split('x').map(Number), 2), width = _b[0], height = _b[1];
...
var Image = /** @class */ (function () {
    ...
    Image.prototype.fireEvent = function (name) {
        ...
        if (eventListeners) {
            try {
                for (var eventListeners_1 = __values(eventListeners), eventListeners_1_1 = eventListeners_1.next(); !eventListeners_1_1.done; eventListeners_1_1 = eventListeners_1.next()) {
