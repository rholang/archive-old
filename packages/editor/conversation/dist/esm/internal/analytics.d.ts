...
export declare type createAnalyticsEvent = (event: object) => UIAnalyticsEvent;
...
export declare function fireEvent(analyticsEvent: UIAnalyticsEvent, eventData: EventData): void;
