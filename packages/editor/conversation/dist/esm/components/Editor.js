...
var AvatarSection = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  /* stylelint-disable value-no-vendor-prefix */\n  -ms-grid-row: 1;\n  -ms-grid-column: 1;\n  /* stylelint-enable */\n  grid-area: avatar-area;\n  margin-right: 8px;\n"], ["\n  /* stylelint-disable value-no-vendor-prefix */\n  -ms-grid-row: 1;\n  -ms-grid-column: 1;\n  /* stylelint-enable */\n  grid-area: avatar-area;\n  margin-right: 8px;\n"])));
var EditorSection = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  /* stylelint-disable value-no-vendor-prefix */\n  -ms-grid-row: 1;\n  -ms-grid-column: 2;\n  /* stylelint-enable */\n  grid-area: editor-area;\n  /* min-width: 0; behavior is described here https://stackoverflow.com/a/43312314 */\n  min-width: 0;\n"], ["\n  /* stylelint-disable value-no-vendor-prefix */\n  -ms-grid-row: 1;\n  -ms-grid-column: 2;\n  /* stylelint-enable */\n  grid-area: editor-area;\n  /* min-width: 0; behavior is described here https://stackoverflow.com/a/43312314 */\n  min-width: 0;\n"])));
var Editor = /** @class */ (function (_super) {
    ...
    function Editor(props) {
        ...
        _this.onSave = function (actions) { return __awaiter(_this, void 0, void 0, function () {
            var value;
        ...
        _this.onChange = function (actions) { return __awaiter(_this, void 0, void 0, function () {
            var value;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        _this.renderEditor = function (actions) {
            ...
            var defaultProps = __assign({ appearance: 'comment', shouldFocus: true, allowCodeBlocks: true, allowLists: true, onSave: function () { return _this.onSave(actions); }, onCancel: _this.onCancel, onChange: debounce(function () { return _this.onChange(actions); }, 250), defaultValue: defaultValue, allowHelpDialog: allowFeedbackAndHelpButtons, feedbackInfo: allowFeedbackAndHelpButtons
                    ? {
                        packageVersion: packageVersion,
                        packageName: packageName,
                    }
                    : undefined, primaryToolbarComponents: allowFeedbackAndHelpButtons
                    ? [React.createElement(ToolbarFeedback, { key: "feedback" }), React.createElement(ToolbarHelp, { key: "help" })]
                    : undefined }, providers);
            return (React.createElement("div", null,
                React.createElement(CollapsedEditor, { placeholder: placeholder, isExpanded: _this.state.isExpanded, onFocus: _this.onFocus }, renderEditor ? (renderEditor(AkEditor, defaultProps)) : (React.createElement(AkEditor, __assign({}, defaultProps))))));
        };
        _this.state = {
