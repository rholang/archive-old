...
var store_1 = tslib_1.__importDefault(require("../internal/store"));
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        result = tslib_1.__assign(tslib_1.__assign({}, tempConversation), { error: error_1 });
                        dispatch({ type: actions_1.CREATE_CONVERSATION_ERROR, payload: result });
                        return [2 /*return*/, result];
                    case 4:
                        dispatch({
                            type: actions_1.CREATE_CONVERSATION_SUCCESS,
                            payload: tslib_1.__assign(tslib_1.__assign({}, result), { localId: localId }),
                        });
                        return [2 /*return*/, tslib_1.__assign(tslib_1.__assign({}, result), { localId: localId })];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        dispatch({
                            ...
                            payload: tslib_1.__assign(tslib_1.__assign({}, result), { localId: tempComment.localId }),
                        });
                        return [2 /*return*/, tslib_1.__assign(tslib_1.__assign({}, result), { localId: tempComment.localId })];
                }
            });
        });
    };
                    ...
                    case 0:
                        ...
                        if (tempComment) {
                            dispatch({
                                ...
                                payload: tslib_1.__assign(tslib_1.__assign({}, tempComment), { document: {
                                        adf: document,
                                    } }),
                            });
                        }
