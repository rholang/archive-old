...
export declare class AbstractConversationResource implements ResourceProvider {
     ...
     */
    getConversations(_objectId: string, _containerId?: string): Promise<Conversation[]>;
    /**
     ...
     */
    create(_localId: string, _value: any, _meta: any, _objectId: string, _containerId?: string): Promise<Conversation>;
    /**
     * Adds a comment to a parent, or update if existing. ParentId can be either a conversation or another comment.
     */
    addComment(_conversationId: string, _parentId: string, _doc: any, _localId?: string): Promise<Comment>;
    /**
     * Updates a comment based on ID. Returns updated content
     */
    updateComment(_conversationId: string, _commentId: string, _document: any): Promise<Comment>;
    /**
     * Deletes a comment based on ID. Returns updated comment.
     */
    deleteComment(_conversationId: string, _commentId: string): Promise<Pick<Comment, 'conversationId' | 'commentId' | 'deleted'>>;
    /**
     * Reverts a comment based on ID.
     */
    revertComment(_conversationId: string, _commentId: string): Promise<Pick<Comment, 'conversationId' | 'commentId'>>;
    /**
     * Updates a user in the store. Returns updated user
     */
    updateUser(_user?: User): Promise<User | undefined>;
    saveDraft(_isLocal: boolean, _value: any, _conversationId: string, _commentId: string | undefined, _meta: any, _objectId: string, _containerId?: string): void;
}
