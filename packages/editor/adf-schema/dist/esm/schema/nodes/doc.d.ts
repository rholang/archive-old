...
import { TaskListDefinition as TaskList, TaskListWithNestingDefinition as NestableTaskList } from './task-list';
 ...
 * @name block_content
 */
export declare type BlockContent = Panel | Paragraph | ParagraphWithMarks | Blockquote | OrderedList | BulletList | Rule | Heading | HeadingWithMarks | CodeBlock | MediaGroup | MediaSingle | DecisionList | TaskList | NestableTaskList | Table | Extension | BodiedExtension | BlockCard;
/**
 * @name table_cell_content
 * @minItems 1
 * @allowUnsupportedBlock true
 */
export declare type TableCellContent = Array<Panel | Paragraph | ParagraphWithMarks | Blockquote | OrderedList | BulletList | Rule | Heading | HeadingWithMarks | CodeBlock | MediaGroup | MediaSingle | DecisionList | TaskList | NestableTaskList | Extension | BlockCard>;
/**
 * @name extension_content
 * @minItems 1
 * @allowUnsupportedBlock true
 */
export declare type ExtensionContent = Array<Panel | Paragraph | Blockquote | OrderedList | BulletList | Rule | Heading | CodeBlock | MediaGroup | MediaSingle | DecisionList | TaskList | NestableTaskList | Table | Extension | BlockCard>;
/**
