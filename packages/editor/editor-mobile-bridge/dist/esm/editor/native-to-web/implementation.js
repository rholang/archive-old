...
import { EditorActions, indentList, outdentList, toggleOrderedList, toggleBulletList, toggleSuperscript, toggleSubscript, toggleStrike, toggleCode, toggleUnderline, toggleEm, toggleStrong, updateStatus, commitStatusPicker, insertBlockType, setBlockType, createTable, insertTaskDecision, changeColor, selectItem as selectTypeAheadItem, insertLink, isTextAtPos, isLinkAtPos, setLinkHref, setLinkText, clearEditorContent, } from '@atlaskit/editor-core';
import { undo as pmHistoryUndo, redo as pmHistoryRedo, } from 'prosemirror-history';
...
var WebBridgeImpl = /** @class */ (function (_super) {
    __extends(WebBridgeImpl, _super);
