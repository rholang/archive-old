...
import { timestampToIsoFormat, calcTableColumnWidths, } from '@atlaskit/editor-common';
...
export default function encode(node, schema) {
    ...
    function encodeText(node) {
        ...
        if (node.text) {
            ...
            try {
                for (var _c = __values(Object.keys(groupedMarks_1)), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var type = _d.value;
                    ...
                    switch (type) {
                        ...
                        case 'confluenceInlineComment':
                            try {
                                ...
                                for (var _e = (e_2 = void 0, __values(__spread(marks).reverse())), _f = _e.next(); !_f.done; _f = _e.next()) {
                                    var mark_1 = _f.value;
