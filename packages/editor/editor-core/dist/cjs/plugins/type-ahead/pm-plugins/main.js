...
var insert_query_1 = require("../commands/insert-query");
var items_list_updated_1 = require("../commands/items-list-updated");
var update_query_1 = require("../commands/update-query");
...
function createPlugin(dispatch, reactContext, typeAhead) {
    return new prosemirror_state_1.Plugin({
        ...
        state: {
            ...
            apply: function (tr, pluginState, _oldState, state) {
                ...
                switch (action) {
                    ...
                    case exports.ACTIONS.SET_QUERY:
        ...
        appendTransaction: function (_trs, _oldState, newState) {
            var pluginState = exports.pluginKey.getState(newState);
            if (pluginState.active &&
                pluginState.query &&
                ...
                var newTr_1;
                select_item_1.selectCurrentItem()(newState, function (tr) { return (newTr_1 = tr); });
                return newTr_1;
            }
            return null;
        },
            ...
            handleDOMEvents: {
                input: function (view, event) {
                    ...
                    if (selection instanceof prosemirror_state_1.TextSelection &&
                        ...
                        update_query_1.updateQueryCommand(event.data)(state, dispatch);
                        return false;
                    }
                    return false;
                },
                ...
                compositionend: function (view, event) {
                    ...
                    if (triggers.indexOf(event.data) !== -1 &&
                        ...
                        selection.$cursor &&
                        !schema.marks.typeAheadQuery.isInSet(selection.$cursor.marks())) {
                        insert_query_1.insertTypeAheadQuery(event.data, true)(state, dispatch);
                        return true;
                    }
                    return false;
                },
...
function defaultActionHandler(_a) {
    ...
    if (!textContent.includes(trigger)) {
        var newPluginState_3 = tslib_1.__assign(tslib_1.__assign({}, createInitialPluginState(true)), { active: true });
...
function setCurrentItemIndex(_a) {
    ...
    var newPluginState = tslib_1.__assign(tslib_1.__assign({}, pluginState), { currentIndex: params.currentIndex || params.currentIndex === 0
            ? params.currentIndex
...
function updateQueryHandler(_a) {
    ...
    var newPluginState = tslib_1.__assign(tslib_1.__assign({}, pluginState), { query: typeof params.query === 'string' ? params.query : null });
    dispatch(exports.pluginKey, newPluginState);
    return newPluginState;
}
exports.updateQueryHandler = updateQueryHandler;
function selectPrevActionHandler(_a) {
    ...
    var newPluginState = tslib_1.__assign(tslib_1.__assign({}, pluginState), { currentIndex: newIndex < 0 ? pluginState.items.length - 1 : newIndex, upKeyCount: ++pluginState.upKeyCount });
    dispatch(exports.pluginKey, newPluginState);
    return newPluginState;
}
...
function selectNextActionHandler(_a) {
    var dispatch = _a.dispatch, pluginState = _a.pluginState;
    var newIndex = pluginState.currentIndex + 1;
    var newPluginState = tslib_1.__assign(tslib_1.__assign({}, pluginState), { currentIndex: newIndex > pluginState.items.length - 1 ? 0 : newIndex, downKeyCount: ++pluginState.downKeyCount });
    dispatch(exports.pluginKey, newPluginState);
    return newPluginState;
}
...
function itemsListUpdatedActionHandler(_a) {
    ...
    var newPluginState = tslib_1.__assign(tslib_1.__assign({}, pluginState), { items: items, itemsLoader: null, currentIndex: pluginState.currentIndex > items.length ? 0 : pluginState.currentIndex });
    dispatch(exports.pluginKey, newPluginState);
    return newPluginState;
}
