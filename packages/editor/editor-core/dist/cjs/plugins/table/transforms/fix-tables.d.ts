...
export declare const removeExtraneousColumnWidths: (node: PMNode<any>, basePos: number, tr: Transaction<any>) => boolean;
export declare const fixTables: (tr: Transaction<any>) => Transaction<any> | undefined;
