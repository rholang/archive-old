...
var service_1 = tslib_1.__importDefault(require("../../../analytics/service"));
var utils_1 = require("../../../utils");
var DropPlaceholder_1 = tslib_1.__importDefault(require("../ui/Media/DropPlaceholder"));
...
var helpers = tslib_1.__importStar(require("../commands/helpers"));
...
var MediaPluginState = /** @class */ (function () {
    function MediaPluginState(state, options, reactContext, mediaPluginOptions) {
        ...
        this.onContextIdentifierProvider = function (_name, provider) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var _a;
                ...
                switch (_f.label) {
                    case 0:
                        if (!mediaProvider) {
                            ...
                            this.allowsUploads = false;
                            if (!this.destroyed) {
                                this.view.dispatch(this.view.state.tr.setMeta(exports.stateKey, {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, media_common_1.getViewMediaClientConfigFromMediaProvider(this.mediaProvider)];
                    case 3:
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, media_common_1.getUploadMediaClientConfigFromMediaProvider(this.mediaProvider)];
                    case 5:
                        _b.uploadMediaClientConfig = _f.sent();
                        _f.label = 6;
                    case 6:
                        assert_1.default(this.mediaProvider.viewMediaClientConfig, "MediaProvider promise did not resolve to a valid instance of MediaProvider - " + this.mediaProvider);
                        return [3 /*break*/, 8];
                    case 7:
                        err_1 = _f.sent();
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, this.initPickers(this.mediaProvider.uploadParams, picker_facade_1.default, this.reactContext)];
                    case 11:
                        _f.sent();
                        return [3 /*break*/, 13];
                    case 12:
        ...
        this.insertFile = function (mediaState, onMediaStateChanged, pickerType) {
            var mediaStateWithContext = tslib_1.__assign(tslib_1.__assign({}, mediaState), { contextId: _this.contextIdentifierProvider
            ...
            if (media_single_1.isMediaSingle(_this.view.state.schema, mediaStateWithContext.fileMimeType)) {
                media_single_1.insertMediaSingleNode(_this.view, mediaStateWithContext, _this.getInputMethod(pickerType), collection);
            }
            else {
                media_files_1.insertMediaGroupNode(_this.view, [mediaStateWithContext], collection);
            }
        ...
        this.getInputMethod = function (pickerType) {
            switch (pickerType) {
                case 'popup':
                    return analytics_1.INPUT_METHOD.PICKER_CLOUD;
                case 'clipboard':
                    return analytics_1.INPUT_METHOD.CLIPBOARD;
                case 'dropzone':
                    return analytics_1.INPUT_METHOD.DRAG_AND_DROP;
            }
            return;
        };
        this.updateMediaNodeAttrs = function (id, attrs, isMediaSingle) {
            ...
            return commands_1.updateMediaNodeAttrs(id, attrs, isMediaSingle)(view.state, view.dispatch);
        };
        this.handleMediaState = function (state) {
            switch (state.status) {
                ...
                case 'mobile-upload-end':
                    ...
                    _this.updateMediaNodeAttrs(state.id, attrs, media_single_1.isMediaSingle(_this.view.state.schema, state.fileMimeType));
        ...
        this.removeNodeById = function (state) {
            var id = state.id;
            var mediaNodeWithPos = helpers.findMediaNode(_this, id, utils_1.isImage(state.fileMimeType));
            if (mediaNodeWithPos) {
        ...
        this.removeSelectedMediaContainer = function () {
            ...
            media_common_1.removeMediaNode(view, selectedNode.firstChild, function () { return from + 1; });
            return true;
        };
        ...
        assert_1.default(nodes.media && (nodes.mediaGroup || nodes.mediaSingle), 'Editor: unable to init media plugin - media or mediaGroup/mediaSingle node absent in schema');
    ...
    MediaPluginState.prototype.getDomElement = function (domAtPos) {
        ...
        var node = prosemirror_utils_1.findDomRefAtPos(selection.from, domAtPos);
        if (node) {
    ...
    MediaPluginState.prototype.trackNewMediaEvent = function (mediaState, onMediaStateChanged, pickerType) {
        service_1.default.trackEvent("atlassian.editor.media.file." + pickerType, mediaState.fileMimeType ? { fileMimeType: mediaState.fileMimeType } : {});
    };
...
exports.createPlugin = function (_schema, options, reactContext, dispatch, mediaPluginOptions) {
        ...
        state: {
            ...
            apply: function (tr, pluginState) {
                ...
                if (meta && dispatch) {
                    ...
                    dispatch(exports.stateKey, tslib_1.__assign(tslib_1.__assign({}, pluginState), { allowsUploads: typeof allowsUploads === 'undefined'
