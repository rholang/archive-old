...
var plugin_1 = require("../../../table/pm-plugins/table-resizing/plugin");
var ResizableMediaSingle = /** @class */ (function (_super) {
    ...
    function ResizableMediaSingle() {
        ...
        _this.calcNewSize = function (newWidth, stop) {
            ...
            var newLayout = prosemirror_utils_1.hasParentNodeOfType(state.schema.nodes.table)(state.selection)
                ? layout
        ...
        _this.highlights = function (newWidth, snapPoints) {
            ...
            if (_this.$pos &&
                !!prosemirror_utils_1.findParentNodeOfTypeClosestToPos(_this.$pos, [layoutColumn, table])) {
                return [];
            }
    ...
    Object.defineProperty(ResizableMediaSingle.prototype, "insideInlineLike", {
        get: function () {
            ...
            return !!prosemirror_utils_1.findParentNodeOfTypeClosestToPos($pos, [listItem]);
        },
        enumerable: true,
        configurable: true
    });
    ResizableMediaSingle.prototype.render = function () {
        ...
        return (React.createElement(styled_1.Wrapper, { width: width, height: height, layout: layout, isResized: !!pctWidth, containerWidth: containerWidth || origWidth, innerRef: function (elem) { return (_this.wrapper = elem); }, fullWidthMode: fullWidthMode },
            React.createElement(Resizer_1.default, tslib_1.__assign({}, this.props, { width: width, height: height, selected: selected, enable: enable, calcNewSize: this.calcNewSize, snapPoints: this.calcSnapPoints(), scaleFactor: !this.wrappedLayout && !this.insideInlineLike ? 2 : 1, highlights: this.highlights, handleResizeStart: function () {
