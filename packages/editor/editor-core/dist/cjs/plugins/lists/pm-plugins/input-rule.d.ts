...
export declare const insertList: (state: EditorState<any>, listType: NodeType<any>, listTypeName: string, start: number, end: number) => import("prosemirror-state").Transaction<any> | null;
