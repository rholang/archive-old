...
var deprecationWarnings = function (className, props, deprecations) {
    ...
    try {
        for (var deprecations_1 = tslib_1.__values(deprecations), deprecations_1_1 = deprecations_1.next(); !deprecations_1_1.done; deprecations_1_1 = deprecations_1.next()) {
...
exports.default = deprecationWarnings;
