...
var AlignmentButton = /** @class */ (function (_super) {
    ...
    AlignmentButton.prototype.render = function () {
        ...
        return (React.createElement(ToolbarButton_1.default, { disabled: false, selected: isSelected, title: label, "aria-label": label, onClick: this.onClick, iconBefore: content }));
    };
