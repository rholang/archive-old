...
exports.Shortcut = styled_components_1.default.div(templateObject_8 || (templateObject_8 = tslib_1.__makeTemplateObject(["\n  background-color: rgba(223, 225, 229, 0.5); /* N60 at 50% */\n  color: ", ";\n  border-radius: ", "px;\n  padding: 4px;\n  line-height: 12px;\n  font-size: 11.67px;\n  align-self: flex-end;\n"], ["\n  background-color: rgba(223, 225, 229, 0.5); /* N60 at 50% */\n  color: ", ";\n  border-radius: ", "px;\n  padding: 4px;\n  line-height: 12px;\n  font-size: 11.67px;\n  align-self: flex-end;\n"])), theme_1.colors.N100, theme_1.borderRadius());
exports.ClickSelectWrapper = styled_components_1.default.span(templateObject_9 || (templateObject_9 = tslib_1.__makeTemplateObject(["\n  user-select: all;\n"], ["\n  user-select: all;\n"])));
