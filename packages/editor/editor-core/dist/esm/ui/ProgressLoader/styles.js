...
export var BackgroundWrapper = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  height: 2px;\n  background-color: ", ";\n  border: transparent;\n  border-radius: ", "px;\n  ", ";\n"], ["\n  height: 2px;\n  background-color: ", ";\n  border: transparent;\n  border-radius: ", "px;\n  ",
    ";\n"])), colors.N20, borderRadius(), function (_a) {
    var maxWidth = _a.maxWidth;
    return css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      max-width: ", "px;\n    "], ["\n      max-width: ", "px;\n    "])), maxWidth);
});
export var ProgressLoaderWrapper = styled.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  flex-grow: 1;\n"], ["\n  flex-grow: 1;\n"])));
export var Container = styled.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n"], ["\n  display: flex;\n  align-items: center;\n"])));
export var LoaderStyle = styled.div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  background-color: ", ";\n  height: 2px;\n  border: transparent;\n  border-radius: ", "px;\n\n  /**\n   * This value was found to be ideal\n   * http://cubic-bezier.com/#.52,.27,0,1.03\n   **/\n  transition: 1s all cubic-bezier(0.52, 0.27, 0, 1.03);\n\n  ", ";\n"], ["\n  background-color: ", ";\n  height: 2px;\n  border: transparent;\n  border-radius: ", "px;\n\n  /**\n   * This value was found to be ideal\n   * http://cubic-bezier.com/#.52,.27,0,1.03\n   **/\n  transition: 1s all cubic-bezier(0.52, 0.27, 0, 1.03);\n\n  ",
