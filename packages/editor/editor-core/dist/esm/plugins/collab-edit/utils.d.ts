...
export declare const replaceDocument: (doc: any, state: EditorState<any>, version?: number | undefined, options?: CollabEditOptions | undefined, providerFactory?: ProviderFactory | undefined, sanitizePrivateContent?: boolean | undefined) => import("prosemirror-state").Transaction<any>;
