...
var CollabProvider = /** @class */ (function () {
     ...
     */
    CollabProvider.prototype.send = function (tr, _oldState, newState) {
    ...
    CollabProvider.prototype.sendMessage = function (data) {
        ...
        switch (type) {
            case 'telepointer':
                this.channel.sendTelepointer(__assign(__assign({}, data), { timestamp: new Date().getTime() }));
        }
    };
    CollabProvider.prototype.queueData = function (data) {
        var _this = this;
        logger("Queuing data for version " + data.version);
        var orderedQueue = __spread(this.queue, [data]).sort(function (a, b) {
    ...
    CollabProvider.prototype.processQeueue = function () {
        ...
        var _a = __read(this.queue, 1), firstItem = _a[0];
     ...
     */
    CollabProvider.prototype.unsubscribeAll = function (evt) {
