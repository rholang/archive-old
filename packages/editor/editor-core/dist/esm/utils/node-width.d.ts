 ...
 */
export declare const getParentNodeWidth: (pos: number | undefined, state: EditorState<any>, containerWidth: WidthPluginState, isFullWidthModeEnabled?: boolean | undefined) => number | undefined;
