...
export declare type MediaImageBase64 = {
    contentId: string;
    contentType: string;
    data: string;
};
...
export interface SerializerWithImages<T> extends Serializer<T> {
    serializeFragmentWithImages(fragment: Fragment, props?: any, target?: any, key?: string): SerializeFragmentWithAttachmentsResult | null;
}
