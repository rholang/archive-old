...
exports.emoji = function (_a) {
    ...
    for (var i = 2; i <= 9 && i <= substring.length; ++i) {
        ...
        var emojiId = exports.wikiToAdfEmojiMapping[candidateText];
        if (emojiId) {
            return {
                type: 'pmnode',
                nodes: [schema.nodes.emoji.createChecked(exports.adfEmojiItems[emojiId])],
                length: i,
            };
        }
    }
