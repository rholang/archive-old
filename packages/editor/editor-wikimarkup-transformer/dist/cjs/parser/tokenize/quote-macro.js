...
exports.quoteMacro = function (_a) {
    ...
    return common_macro_1.commonMacro(input.substring(position), schema, {
        keyword: 'quote',
        paired: true,
        rawContentProcessor: exports.rawContentProcessor,
        context: context,
    });
};
exports.rawContentProcessor = function (_rawAttrs, rawContent, length, schema, context) {
    ...
    var parsedContent = text_2.parseString({
        schema: schema,
        context: context,
        ignoreTokenTypes: [],
        input: rawContent,
...
function transformHeading(heading, schema) {
    ...
    heading.content.forEach(function (n) {
        ...
        if (n.type.name === 'text') {
            ...
            if (heading.attrs.level <= 4 && !text_1.hasAnyOfMarks(n, ['strong', 'code'])) {
                n = n.mark(tslib_1.__spread(n.marks, [strong]));
            }
            if ((heading.attrs.level === 5 || heading.attrs.level === 2) &&
                !text_1.hasAnyOfMarks(n, ['em', 'code'])) {
                n = n.mark(tslib_1.__spread(n.marks, [italic]));
            }
            if (heading.attrs.level > 3 && !text_1.hasAnyOfMarks(n, ['textColor', 'code'])) {
