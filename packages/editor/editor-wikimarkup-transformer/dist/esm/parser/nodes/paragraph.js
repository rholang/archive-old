...
export function createParagraphNodeFromInlineNodes(inlineNodes, schema) {
    ...
    var hardbreakBuffer = [];
    try {
        for (var inlineNodes_1 = __values(inlineNodes), inlineNodes_1_1 = inlineNodes_1.next(); !inlineNodes_1_1.done; inlineNodes_1_1 = inlineNodes_1.next()) {
            ...
            buffer.push.apply(buffer, __spread(hardbreakBuffer, [node]));
            hardbreakBuffer = [];
        }
    }
