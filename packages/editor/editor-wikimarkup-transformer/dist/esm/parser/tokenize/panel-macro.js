...
var rawContentProcessor = function (rawAttrs, rawContent, length, schema, context) {
    ...
    var nodeAttrs = __assign(__assign({}, parsedAttrs), { panelType: getPanelType(parsedAttrs) });
    ...
    var contentBuffer = parsedAttrs.title
        ...
        : [];
    try {
        for (var normalizedContent_1 = __values(normalizedContent), normalizedContent_1_1 = normalizedContent_1.next(); !normalizedContent_1_1.done; normalizedContent_1_1 = normalizedContent_1.next()) {
