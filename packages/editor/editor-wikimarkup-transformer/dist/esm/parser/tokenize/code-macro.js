...
var rawContentProcessor = function (rawAttrs, rawContent, length, schema) {
    ...
    var nodeAttrs = __assign(__assign({}, parsedAttrs), { language: getCodeLanguage(parsedAttrs) });
...
function getCodeLanguage(attrs) {
    ...
    try {
        for (var SUPPORTED_CODEBOCK_LANGUAGES_1 = __values(SUPPORTED_CODEBOCK_LANGUAGES), SUPPORTED_CODEBOCK_LANGUAGES_1_1 = SUPPORTED_CODEBOCK_LANGUAGES_1.next(); !SUPPORTED_CODEBOCK_LANGUAGES_1_1.done; SUPPORTED_CODEBOCK_LANGUAGES_1_1 = SUPPORTED_CODEBOCK_LANGUAGES_1.next()) {
