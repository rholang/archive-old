...
export function resolveLink(link, schema, context) {
    ...
    try {
        for (var linkResolverStrategies_1 = __values(linkResolverStrategies), linkResolverStrategies_1_1 = linkResolverStrategies_1.next(); !linkResolverStrategies_1_1.done; linkResolverStrategies_1_1 = linkResolverStrategies_1.next()) {
