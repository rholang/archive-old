...
export default function MediaSingle(_a) {
    ...
    return (React.createElement(Wrapper, { layout: layout, width: width, height: height, containerWidth: containerWidth, pctWidth: pctWidth, fullWidthMode: fullWidthMode, "data-node-type": "mediaSingle", "data-layout": layout, "data-width": pctWidth, className: classnames('media-single', "image-" + layout, className, {
