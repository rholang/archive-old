...
var Document = /** @class */ (function (_super) {
    ...
    Document.prototype.renderEditor = function () {
        ...
        return (React.createElement(EditorContext, null,
            React.createElement(Editor, __assign({ appearance: "full-page", placeholder: "Write something...", defaultValue: body, primaryToolbarComponents: this.renderToolbar(), contentComponents: this.renderTitle() }, editorProps))));
    };
    Document.prototype.render = function () {
        ...
        switch (mode) {
            ...
            default:
                ...
                return (React.createElement(ReactRenderer, __assign({ dataProviders: dataProviders, document: JSON.parse(body) }, rendererProps)));
        }
    };
    return Document;
}(Component));
