...
var Content = styled_components_1.default.div(templateObject_1 || (templateObject_1 = tslib_1.__makeTemplateObject(["\n  line-height: 24px;\n  height: 100%;\n  width: 100%;\n  max-width: ", "px;\n  padding-top: 50px;\n  margin: 0 auto;\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1;\n  padding-bottom: 55px;\n\n  & > * {\n    padding: 0 32px;\n  }\n"], ["\n  line-height: 24px;\n  height: 100%;\n  width: 100%;\n  max-width: ", "px;\n  padding-top: 50px;\n  margin: 0 auto;\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1;\n  padding-bottom: 55px;\n\n  & > * {\n    padding: 0 32px;\n  }\n"])), exports.akEditorFullPageMaxWidth + editor_common_1.akEditorGutterPadding * 2);
var EmbeddedDocument = /** @class */ (function (_super) {
    ...
    function EmbeddedDocument(props) {
        ...
        _this.provider = provider_1.getProvider(props);
        _this.state = {
    ...
    EmbeddedDocument.prototype.render = function () {
        ...
        return (React.createElement(context_1.Context.Provider, { value: {
                value: this.state,
