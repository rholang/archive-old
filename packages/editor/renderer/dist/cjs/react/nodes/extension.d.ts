...
import { ExtensionHandlers, OverflowShadowProps } from '@atlaskit/editor-common';
...
export declare const renderExtension: (content: any, layout: string, options?: OverflowShadowProps | undefined) => JSX.Element;
