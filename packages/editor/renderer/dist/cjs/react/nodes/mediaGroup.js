...
var MediaGroup = /** @class */ (function (_super) {
    ...
    MediaGroup.prototype.renderSingleFile = function (child) {
        return React.cloneElement(child, {
            ...
            cardDimensions: media_card_1.defaultImageCardDimensions,
    ...
    MediaGroup.prototype.cloneFileCard = function (child, surroundingItems) {
        ...
        return React.cloneElement(child, {
            useInlinePlayer: false,
            eventHandlers: tslib_1.__assign(tslib_1.__assign({}, child.props.eventHandlers), { media: {
                    onClick: onClick,
                } }),
        });
    };
    MediaGroup.prototype.renderStrip = function () {
        ...
        return (React.createElement(media_filmstrip_1.FilmstripView, { animate: animate, offset: offset, onSize: this.handleSize, onScroll: this.handleScroll }, React.Children.map(children, function (rawChild) {
            var child = rawChild;
