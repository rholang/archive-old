...
export var getListOfIdentifiersFromDoc = function (doc) {
    if (!doc) {
        return [];
    }
    return filter(doc, function (node) { return node.type === 'media'; }).reduce(function (identifierList, mediaNode) {
        if (mediaNode.attrs) {
...
var MediaCardInternal = /** @class */ (function (_super) {
    __extends(MediaCardInternal, _super);
    function MediaCardInternal() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.state = {};
        _this.saveFileState = function (id, mediaClientConfig) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        if (rendererContext && rendererContext.adDoc && !nodeIsInCache) {
                            getListOfIdentifiersFromDoc(rendererContext.adDoc).forEach(function (identifier) {
                                if (identifier.mediaItemType === 'file') {
                                    mediaIdentifierMap.set(identifier.id, __assign(__assign({}, identifier), { collectionName: collectionName }));
                                }
    ...
    MediaCardInternal.prototype.render = function () {
        ...
        if (!id || type !== 'file') {
            return React.createElement(CardError, { dimensions: cardDimensions });
        }
        ...
        return (React.createElement(CardWrapper, __assign({}, getClipboardAttrs({
            id: id,
...
export var getClipboardAttrs = function (_a) {
