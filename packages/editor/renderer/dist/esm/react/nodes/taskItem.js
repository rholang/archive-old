    ...
    function TaskItem(props) {
        ...
        _this.renderWithProvider = function (providers) {
            ...
            return (React.createElement(FabricElementsAnalyticsContext, { data: {
                ...
                React.createElement(TaskItemWithProviders, { objectAri: objectAri, taskId: localId, isDone: state === 'DONE', taskDecisionProvider: taskDecisionProvider, contextIdentifierProvider: contextIdentifierProvider }, children)));
        };
