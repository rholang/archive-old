...
var TaskItemWithProviders = /** @class */ (function (_super) {
    ...
    TaskItemWithProviders.prototype.render = function () {
        var _a = this.props, contextIdentifierProvider = _a.contextIdentifierProvider, objectAri = _a.objectAri, otherProps = __rest(_a, ["contextIdentifierProvider", "objectAri"]);
        var resolvedObjectId = (this.state.resolvedContextProvider &&
            this.state.resolvedContextProvider.objectId) ||
            objectAri;
        return React.createElement(ResourcedTaskItem, __assign({}, otherProps, { objectAri: resolvedObjectId }));
    };
