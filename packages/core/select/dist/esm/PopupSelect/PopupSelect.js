...
function (_PureComponent) {
  ...
  function PopupSelect() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderSelect", function () {
      ...
      var popper = ___EmotionJSX(Popper, mergedPopperProps, function (_ref2) {
        var placement = _ref2.placement,
            ref = _ref2.ref,
            style = _ref2.style;
        return ___EmotionJSX(NodeResolver, {
          innerRef: _this.resolveMenuRef(ref)
        }, ___EmotionJSX(MenuDialog, {
          style: style,
  ...
  _createClass(PopupSelect, [{
    ...
    value: function render() {
      ...
      return ___EmotionJSX(Manager, null, ___EmotionJSX(Reference, null, function (_ref3) {
        var ref = _ref3.ref;
        return target({
