    ...
    return function (view) {
      ...
      view.forEach(function (viewItem) {
        ...
        if (Array.isArray(item)) {
          newView = [].concat((0, _toConsumableArray2.default)(newView), (0, _toConsumableArray2.default)(item));
        } else if (item && (0, _typeof2.default)(item) === 'object') {
          newView = [].concat((0, _toConsumableArray2.default)(newView), [item]);
        }
      });
      return newView;
    };
...
var insertBefore = function insertBefore(inserted) {
  return function (item) {
    return [].concat((0, _toConsumableArray2.default)(inserted), [item]);
  };
...
var appendChildren = function appendChildren(appended) {
  return function (item) {
    return (0, _objectSpread2.default)({}, item, {
      items: [].concat((0, _toConsumableArray2.default)(item.items || []), (0, _toConsumableArray2.default)(appended))
    });
  };
...
var prependChildren = function prependChildren(prepended) {
  return function (item) {
    return (0, _objectSpread2.default)({}, item, {
      items: [].concat((0, _toConsumableArray2.default)(prepended), (0, _toConsumableArray2.default)(item.items || []))
    });
  };
};
/**
