...
function (_Container) {
  ...
  function ViewState(options) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "setDebug", function (enabled) {
      _this.logger.setDebug(enabled);
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "addReducer", function (viewKey, reducer) {
      var source = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'unknown';
      var reducerList = [].concat((0, _toConsumableArray2.default)(_this.reducers[viewKey] || []), [{
        source: source,
        fn: reducer
      }]);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "removeReducer", function (viewKey, reducer) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "addView", function (viewKey, viewGetter) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "setView", function (maybeViewKey) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "setViewData", function (viewKey, viewData) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "updateActiveView", function (maybeViewKey) {
