...
var getStyles = function getStyles(provided, _ref) {
  ...
  return (0, _objectSpread2.default)({}, provided, {
    itemBase: (0, _objectSpread2.default)({}, provided.itemBase, {
      boxShadow: isDragging ? "".concat(_colors.N60A, " 0px 4px 8px -2px, ").concat(_colors.N60A, " 0px 0px 1px") : undefined,
...
function (_Component) {
  ...
  (0, _createClass2.default)(SortableItem, [{
    ...
    value: function render() {
      ...
      return (0, _core.jsx)(_reactBeautifulDnd.Draggable, {
        ...
        return (0, _core.jsx)(_Item.default, (0, _extends2.default)({
