...
function (_Component) {
  ...
  function SortableContext() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onDragStart", function (_ref, emit) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onDragEnd", function (_ref3, emit) {
  ...
  (0, _createClass2.default)(SortableContext, [{
    ...
    value: function render() {
      ...
      return (0, _core.jsx)(_LayoutEvent.LayoutEventEmitter, null, function (_ref5) {
        var emitItemDragStart = _ref5.emitItemDragStart,
            emitItemDragEnd = _ref5.emitItemDragEnd;
        return (0, _core.jsx)(_reactBeautifulDnd.DragDropContext, {
