...
function (_PureComponent) {
  ...
  function ResizeTransition() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "getTarget", function (ref) {
      _this.target = ref;
  ...
  (0, _createClass2.default)(ResizeTransition, [{
    ...
    value: function render() {
      ...
      return (0, _core.jsx)(_Transition.default, {
        ...
        var transitionStyle = (0, _objectSpread2.default)({}, willChange, cssTransition, dynamicProperties[transitionState]);
...
(0, _defineProperty2.default)(ResizeTransition, "defaultProps", {
  onExpandStart: NOOP,
  onExpandEnd: NOOP,
