...
var _styles3 = _interopRequireDefault(require("../components/presentational/ContentNavigation/styles"));
...
var _styles7 = _interopRequireDefault(require("../components/presentational/Section/styles"));

var _styles8 = _interopRequireDefault(require("../components/presentational/SkeletonItem/styles"));
...
var _default = function _default(_ref7) {
  ...
  return {
    ...
    section: (0, _styles7.default)(modeColors),
    separator: (0, _styles6.default)(modeColors),
    skeletonItem: (0, _styles8.default)(modeColors)
  };
};
