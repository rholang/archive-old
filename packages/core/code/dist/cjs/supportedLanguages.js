...
exports.SUPPORTED_LANGUAGE_ALIASES = Object.freeze([
    {
        name: 'PHP',
...
exports.normalizeLanguage = memoize_one_1.default(function (language) {
    if (!language) {
        return '';
    }
    var match = exports.SUPPORTED_LANGUAGE_ALIASES.find(function (val) {
