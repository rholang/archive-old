...
function (_PureComponent) {
  (0, _inherits2.default)(CreateDrawer, _PureComponent);

  function CreateDrawer() {
    (0, _classCallCheck2.default)(this, CreateDrawer);
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(CreateDrawer).apply(this, arguments));
  }

  (0, _createClass2.default)(CreateDrawer, [{
    key: "render",
