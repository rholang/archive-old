...
var TextAreaElement = /** @class */ (function (_super) {
    ...
    TextAreaElement.prototype.render = function () {
        ...
        if (resize === 'smart') {
            return (react_1.default.createElement("textarea", tslib_1.__assign({ ref: this.getTextAreaRef, style: { height: height } }, rest, { onChange: this.handleOnChange })));
        }
        return (react_1.default.createElement("textarea", tslib_1.__assign({ ref: this.getTextAreaRef, style: { height: '100%' } }, rest)));
    };
