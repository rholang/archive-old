...
var JiraWordmark = /** @class */ (function (_super) {
    tslib_1.__extends(JiraWordmark, _super);
    function JiraWordmark() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    JiraWordmark.prototype.render = function () {
        return react_1.default.createElement(Wrapper_1.default, tslib_1.__assign({}, this.props, { svg: svg }));
    };
    JiraWordmark.defaultProps = constants_1.DefaultProps;
    return JiraWordmark;
}(react_1.Component));
exports.default = JiraWordmark;
