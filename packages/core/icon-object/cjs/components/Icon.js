...
var Icon = /** @class */ (function (_super) {
    ...
    Icon.prototype.render = function () {
        var _a = this.props, dangerouslySetGlyph = _a.dangerouslySetGlyph, size = _a.size;
        return (react_1.default.createElement(exports.IconWrapper, { size: size, "aria-label": this.props.label, dangerouslySetInnerHTML: dangerouslySetGlyph
                ? {
