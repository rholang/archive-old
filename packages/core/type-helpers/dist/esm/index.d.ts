...
export declare const withDefaultProps: <P, DP extends Partial<P>>(defaultProps: DP, Component: React.ComponentType<P>) => React.ComponentType<Partial<Pick<P, Exclude<keyof P, Exclude<keyof P, Extract<keyof P, keyof DP> | Extract<keyof DP, keyof P>>>>> & Pick<P, Exclude<keyof P, Extract<keyof P, keyof DP> | Extract<keyof DP, keyof P>>>>;
