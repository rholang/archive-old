...
function (_React$Component) {
  ...
  function Form() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onSubmitProxy", function () {
      var _this$props;

      return (_this$props = _this.props).onSubmit.apply(_this$props, arguments);
    });

    _defineProperty(_assertThisInitialized(_this), "form", createFinalForm(_this.onSubmitProxy, _this.formRef));
