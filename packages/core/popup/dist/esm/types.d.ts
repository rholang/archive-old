import { CSSProperties, Dispatch, FC, ReactNode, Ref, SetStateAction, ComponentType } from 'react';
...
export declare type PopupRef = HTMLDivElement | undefined;
export declare type PopupComponentProps = {
    children: ReactNode;
